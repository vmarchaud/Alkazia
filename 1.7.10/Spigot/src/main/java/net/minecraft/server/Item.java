...
public class Item {
	...
	public static void l() {
        ...
        /** Alkazia */
        REGISTRY.a(450, "bauxite_helmet", (new ItemArmor(EnumArmorMaterial.BAUXITE, 5, 0)).c("helmetBauxite").f("bauxite_helmet"));
        REGISTRY.a(451, "bauxite_chestplate", (new ItemArmor(EnumArmorMaterial.BAUXITE, 5, 1)).c("chestplateBauxite").f("bauxite_chestplate"));
        REGISTRY.a(452, "bauxite_leggings", (new ItemArmor(EnumArmorMaterial.BAUXITE, 5, 2)).c("leggingsBauxite").f("bauxite_leggings"));
        REGISTRY.a(453, "bauxite_boots", (new ItemArmor(EnumArmorMaterial.BAUXITE, 5, 3)).c("bootsBauxite").f("bauxite_boots"));
        
        REGISTRY.a(454, "granite_helmet", (new ItemArmor(EnumArmorMaterial.GRANITE, 6, 0)).c("helmetGranite").f("granite_helmet"));
        REGISTRY.a(455, "granite_chestplate", (new ItemArmor(EnumArmorMaterial.GRANITE, 6, 1)).c("chestplateGranite").f("granite_chestplate"));
        REGISTRY.a(456, "granite_leggings", (new ItemArmor(EnumArmorMaterial.GRANITE, 6, 2)).c("leggingsGranite").f("granite_leggings"));
        REGISTRY.a(457, "granite_boots", (new ItemArmor(EnumArmorMaterial.GRANITE, 6, 3)).c("bootsGranite").f("granite_boots"));
        
        REGISTRY.a(458, "opale_helmet", (new ItemArmor(EnumArmorMaterial.OPALE, 7, 0)).c("helmetOpale").f("opale_helmet"));
        REGISTRY.a(459, "opale_chestplate", (new ItemArmor(EnumArmorMaterial.OPALE, 7, 1)).c("chestplateOpale").f("opale_chestplate"));
        REGISTRY.a(460, "opale_leggings", (new ItemArmor(EnumArmorMaterial.OPALE, 7, 2)).c("leggingsOpale").f("opale_leggings"));
        REGISTRY.a(461, "opale_boots", (new ItemArmor(EnumArmorMaterial.OPALE, 7, 3)).c("bootsOpale").f("opale_boots"));
        
        REGISTRY.a(462, "meteor_helmet", (new ItemArmor(EnumArmorMaterial.METEOR, 8, 0)).c("helmetMeteor").f("meteor_helmet"));
        REGISTRY.a(463, "meteor_chestplate", (new ItemArmor(EnumArmorMaterial.METEOR, 8, 1)).c("chestplateMeteor").f("meteor_chestplate"));
        REGISTRY.a(464, "meteor_leggings", (new ItemArmor(EnumArmorMaterial.METEOR, 8, 2)).c("leggingsMeteor").f("meteor_leggings"));
        REGISTRY.a(465, "meteor_boots", (new ItemArmor(EnumArmorMaterial.METEOR, 8, 3)).c("bootsMeteor").f("meteor_boots"));
        
        REGISTRY.a(466, "ninja_helmet", (new ItemArmor(EnumArmorMaterial.NINJA, 9, 0)).c("helmetNinja").f("ninja_helmet"));
        REGISTRY.a(467, "ninja_chestplate", (new ItemArmor(EnumArmorMaterial.NINJA, 9, 1)).c("chestplateNinja").f("ninja_chestplate"));
        REGISTRY.a(468, "ninja_leggings", (new ItemArmor(EnumArmorMaterial.NINJA, 9, 2)).c("leggingsNinja").f("ninja_leggings"));
        REGISTRY.a(469, "ninja_boots", (new ItemArmor(EnumArmorMaterial.NINJA, 9, 3)).c("bootsNinja").f("ninja_boots"));
        
        REGISTRY.a(470, "bauxite_sword", (new ItemSword(EnumToolMaterial.BAUXITE)).c("swordGarnet").f("bauxite_sword"));
        REGISTRY.a(471, "bauxite_shovel", (new ItemSpade(EnumToolMaterial.BAUXITE)).c("shovelGarnet").f("bauxite_shovel"));
        REGISTRY.a(472, "bauxite_pickaxe", (new ItemPickaxe(EnumToolMaterial.BAUXITE)).c("pickaxeGarnet").f("bauxite_pickaxe"));
        REGISTRY.a(473, "bauxite_axe", (new ItemAxe(EnumToolMaterial.BAUXITE)).c("hatchetGarnet").f("bauxite_axe"));
        REGISTRY.a(474, "bauxite_hoe", (new ItemHoe(EnumToolMaterial.BAUXITE)).c("hoeGarnet").f("bauxite_hoe"));
        
        REGISTRY.a(475, "granite_sword", (new ItemSword(EnumToolMaterial.GRANITE)).c("swordGarnet").f("granite_sword"));
        REGISTRY.a(476, "granite_shovel", (new ItemSpade(EnumToolMaterial.GRANITE)).c("shovelGarnet").f("granite_shovel"));
        REGISTRY.a(477, "granite_pickaxe", (new ItemPickaxe(EnumToolMaterial.GRANITE)).c("pickaxeGarnet").f("granite_pickaxe"));
        REGISTRY.a(478, "granite_axe", (new ItemAxe(EnumToolMaterial.GRANITE)).c("hatchetGarnet").f("granite_axe"));
        REGISTRY.a(479, "granite_hoe", (new ItemHoe(EnumToolMaterial.GRANITE)).c("hoeGarnet").f("granite_hoe"));
        
        REGISTRY.a(480, "opale_sword", (new ItemSword(EnumToolMaterial.OPALE)).c("swordGarnet").f("opale_sword"));
        REGISTRY.a(481, "opale_shovel", (new ItemSpade(EnumToolMaterial.OPALE)).c("shovelGarnet").f("opale_shovel"));
        REGISTRY.a(482, "opale_pickaxe", (new ItemPickaxe(EnumToolMaterial.OPALE)).c("pickaxeGarnet").f("opale_pickaxe"));
        REGISTRY.a(483, "opale_axe", (new ItemAxe(EnumToolMaterial.OPALE)).c("hatchetGarnet").f("opale_axe"));
        REGISTRY.a(484, "opale_hoe", (new ItemHoe(EnumToolMaterial.OPALE)).c("hoeGarnet").f("opale_hoe"));
        
        REGISTRY.a(485, "meteor_sword", (new ItemSword(EnumToolMaterial.METEOR)).c("swordGarnet").f("meteor_sword"));
        REGISTRY.a(486, "meteor_shovel", (new ItemSpade(EnumToolMaterial.METEOR)).c("shovelGarnet").f("meteor_shovel"));
        REGISTRY.a(487, "meteor_pickaxe", (new ItemPickaxe(EnumToolMaterial.METEOR)).c("pickaxeGarnet").f("meteor_pickaxe"));
        REGISTRY.a(488, "meteor_axe", (new ItemAxe(EnumToolMaterial.METEOR)).c("hatchetGarnet").f("meteor_axe"));
        REGISTRY.a(489, "meteor_hoe", (new ItemHoe(EnumToolMaterial.METEOR)).c("hoeGarnet").f("meteor_hoe"));
        
        REGISTRY.a(490, "bowBauxite", (new ItemBowBauxite()).c("bowBauxite").f("bowBauxite"));
        REGISTRY.a(491, "bowGranite", (new ItemBowGranite()).c("bowGranite").f("bowGranite"));
        REGISTRY.a(492, "bowOpale", (new ItemBowOpale()).c("bowOpale").f("bowOpale"));
        REGISTRY.a(493, "bowMeteor", (new ItemBowMeteor()).c("bowMeteor").f("bowMeteor"));
        
        REGISTRY.a(495, "bauxite_ingot", (new Item()).c("ingotBauxite").a(CreativeModeTab.l).f("bauxite_ingot"));
        REGISTRY.a(496, "granite", (new Item()).c("granite").a(CreativeModeTab.l).f("granite"));
        REGISTRY.a(497, "opale", (new Item()).c("opale").a(CreativeModeTab.l).f("opale"));
        REGISTRY.a(498, "meteor_fragment", (new Item()).c("fragmentMeteor").a(CreativeModeTab.l).f("meteor_fragment"));
        REGISTRY.a(499, "potionMilk", (new ItemPotionMilk().c("potionMilk").a(CreativeModeTab.l).f("potionMilk")));
        REGISTRY.a(500, "stuff", (new ItemStuff(4, 4.0F, false).c("chocolat").f("stuff")));
        REGISTRY.a(501, "ninjaPowder", (new Item()).c("ninjaPowder").a(CreativeModeTab.l).f("ninjaPowder"));
        
        // Alkazia V2
        REGISTRY.a(502, "sheep", (new ItemFood(3, 0.3F, true)).c("sheepRaw").f("sheep_raw"));
        REGISTRY.a(503, "cooked_sheep", (new ItemFood(8, 0.8F, true)).c("sheepCooked").f("sheep_cooked"));
        REGISTRY.a(504, "fallPotion", (new ItemPotionFall()).c("fallPotion").f("potionFall"));
        // Alkazia - V4

        REGISTRY.a(505, "drinkStuff", (new ItemDrinkableStuff()).c("drinkableStuff").f("hotChocolate"));
        
        REGISTRY.a(506, "potionHaste", (new ItemPotionHaste(0)).c("potionHaste").f("potionHaste"));
        REGISTRY.a(507, "potionHaste2", (new ItemPotionHaste(1)).c("potionHaste2").f("potionHaste"));
        REGISTRY.a(508, "potionResistance", (new ItemPotionResistance(0)).c("potionResistance").f("potionResistance"));
        REGISTRY.a(509, "potionResistance2", (new ItemPotionResistance(1)).c("potionResistance2").f("potionResistance"));
        REGISTRY.a(510, "potionJump", (new ItemPotionJump(0)).c("potionJump").f("potionJump"));
        REGISTRY.a(511, "potionJump2", (new ItemPotionJump(1)).c("potionJump2").f("potionJump"));
