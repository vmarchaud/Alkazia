...
public class Blocks {
    ...
    /** Alkazia - Registry Block*/
    public static final Block BAUXITE_ORE = (Block)Block.REGISTRY.get("bgetuxite_ore");
    public static final Block GRANITE_ORE = (Block)Block.REGISTRY.get("granite_ore");
    public static final Block OPALE_ORE = (Block)Block.REGISTRY.get("opale_ore");
    public static final Block METEOR_ORE = (Block)Block.REGISTRY.get("meteor_ore");
    
    public static final Block BAUXITE_BLOCK = (Block)Block.REGISTRY.get("bauxite_block");
    public static final Block GRANITE_BLOCK = (Block)Block.REGISTRY.get("granite_block");
    public static final Block OPALE_BLOCK = (Block)Block.REGISTRY.get("opale_block");
    public static final Block METEOR_BLOCK = (Block)Block.REGISTRY.get("meteor_block");
    
    public static final Block POUSSE = (Block)Block.REGISTRY.get("pousse");
    public static final BlockIronChest IRON_CHEST = (BlockIronChest)Block.REGISTRY.get("iron_chest");
    public static final Block METEORITE = (Block)Block.REGISTRY.get("meteorite");
    public static final Block INVISIBLE = (Block)Block.REGISTRY.get("invisible");
    public static final Block LUMIERE = (Block)Block.REGISTRY.get("lumiere");
    //public static final Block INVISIBLE_DOOR_BLOCK = (Block)Block.REGISTRY.a("invisible_door");
    

    // Alkazia - Register new block - V2 -
    
    public static final Block andesite = (Block)(Block)Block.REGISTRY.get("andesite");
    public static final Block andesite_smooth = (Block)(Block)Block.REGISTRY.get("andesite_smooth");
    public static final Block alumite = (Block)(Block)Block.REGISTRY.get("alumite");
    public static final Block alumite_smooth = (Block)(Block)Block.REGISTRY.get("alumite_smooth");
    public static final Block diorite = (Block)(Block)Block.REGISTRY.get("diorite");
    public static final Block diorite_smooth = (Block)(Block)Block.REGISTRY.get("diorite_smooth");
    public static final Block ironLadder = (Block)(Block)Block.REGISTRY.get("ironLadder");
    public static final Block blockPowder = (Block)(Block)Block.REGISTRY.get("blockPowder");
    
    // Alkazia - V3
    

    public static final Block fakub = (Block)(Block)Block.REGISTRY.get("fakub");
    public static final Block fakub_off = (Block)(Block)Block.REGISTRY.get("fakub_off");

    public static final Block present = (Block)(Block)Block.REGISTRY.get("present");
}
