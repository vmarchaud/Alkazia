...
public class EntityTracker {
	...
	public EntityTracker(WorldServer worldserver) {
		world = worldserver;
		e = worldserver.getMinecraftServer().getPlayerList().d();
	}
	...
	public void addEntity(Entity entity, int i, int j, boolean flag) {
		...
		try {
			...
			((EntityTrackerEntry) trackedEntities.get(entity.getId())).tracker.a(crashreportsystemdetails1);
	...
	public void untrackEntity(Entity entity) {
		...
		EntityTrackerEntry entitytrackerentry1 = (EntityTrackerEntry) trackedEntities.d(entity.getId());
	...
	public void a(Entity entity, Packet packet) {
		EntityTrackerEntry entitytrackerentry = (EntityTrackerEntry) trackedEntities.get(entity.getId());
