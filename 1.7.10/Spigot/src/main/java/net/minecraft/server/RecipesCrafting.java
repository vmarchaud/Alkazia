...
public class RecipesCrafting {
    ...
    public void a(CraftingManager craftingmanager) {
        ...
        //craftingmanager.registerShapedRecipe(new ItemStack(Items.stuff, 1), new Object[] { "###", "###", Character.valueOf('#'),  new ItemStack(Items.INK_SACK, 1, 3)});


        craftingmanager.registerShapedRecipe(new ItemStack(Blocks.ironLadder, 4), new Object[] { "# #", "###", "# #", Character.valueOf('#'), Items.IRON_INGOT});
        craftingmanager.registerShapedRecipe(new ItemStack(Items.potionFall), new Object[] { "#O#", Character.valueOf('#'), Items.FEATHER, Character.valueOf('O'), Items.POTION});
