...
public class EnchantmentProtection extends Enchantment {
    ...
    public int a(int i, DamageSource damagesource) {
        if (damagesource.ignoresInvulnerability()) {
            ...
            return this.a == 0 ? MathHelper.d(f * 0.75F) : 
            	(this.a == 1 && damagesource.o() ? MathHelper.d(f * 0.95F) : // Alkazia - try to fix protection enchantment
            		(this.a == 2 && damagesource == DamageSource.FALL ? MathHelper.d(f * 2.5F) : 
            			(this.a == 3 && damagesource.isExplosion() ? MathHelper.d(f * 1.5F) : 
            				(this.a == 4 && damagesource.a() ? MathHelper.d(f * 1.5F) : 0))));
        }
    }
