...
public class BlockFire extends Block {
	...
	private void a(World world, int i, int j, int k, int l, Random random, int i1) {
		int j1 = b[Block.getId(world.getType(i, j, k))];
	...
	public boolean e(IBlockAccess iblockaccess, int i, int j, int k) {
		return a[Block.getId(iblockaccess.getType(i, j, k))] > 0;
	}

	public int a(World world, int i, int j, int k, int l) {
		int i1 = a[Block.getId(world.getType(i, j, k))];
	...
	public boolean canPlace(World world, int i, int j, int k) {
		return World.a(world, i, j - 1, k) || this.e(world, i, j, k);
	}

	@Override
	public void doPhysics(World world, int i, int j, int k, Block block) {
		if (!World.a(world, i, j - 1, k) && !this.e(world, i, j, k)) {
