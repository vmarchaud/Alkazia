...
public class PacketStatusListener implements PacketStatusInListener {
	...
	public void a(PacketStatusInStart packetstatusinstart) {
		...
		networkManager.handle(new PacketStatusOutServerInfo(ping), new GenericFutureListener[0]);
		// CraftBukkit end
	}

	@Override
	public void a(PacketStatusInPing packetstatusinping) {
		networkManager.handle(new PacketStatusOutPong(packetstatusinping.c()), new GenericFutureListener[0]);
	}
}
