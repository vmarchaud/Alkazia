...
public class ContainerAnvil extends Container {
	...
	public ContainerAnvil(PlayerInventory playerinventory, World world, int i, int j, int k, EntityHuman entityhuman) {
		...
		l = k;
		o = entityhuman;
		this.a(new Slot(h, 0, 27, 47));
		this.a(new Slot(h, 1, 76, 47));
		this.a(new SlotAnvilResult(this, g, 2, 134, 47, world, i, j, k));
	...
	public void e() {
		...
		if (itemstack == null) {
			...
			if (itemstack2 != null) {
				...
				if (itemstack1.g() && itemstack1.getItem().a(itemstack, itemstack2)) {
					...
					while (iterator.hasNext()) {
						...
						if (o.abilities.canInstantlyBuild || itemstack.getItem() == Items.ENCHANTED_BOOK) {
							flag1 = true;
						}
			...
			} else if (!n.equals(itemstack.getName())) {
				j = itemstack.g() ? 7 : itemstack.count * 5;
				i += j;
				if (itemstack.hasName()) {
					k += j / 2;
			...
			if (a >= 40 && !o.abilities.canInstantlyBuild) {
				itemstack1 = null;
			}
	...
	public void addSlotListener(ICrafting icrafting) {
		...
		icrafting.setContainerData(this, 0, a);
	}
	...
	public void b(EntityHuman entityhuman) {
		...
		if (!i.isStatic) {
			for (int i = 0; i < h.getSize(); ++i) {
				ItemStack itemstack = h.splitWithoutUpdate(i);
	...
	public boolean a(EntityHuman entityhuman) {
		...
		return i.getType(j, k, l) != Blocks.ANVIL ? false : entityhuman.e(j + 0.5D, k + 0.5D, l + 0.5D) <= 64.0D;
	}
	...
	public CraftInventoryView getBukkitView() {
		...
		org.bukkit.craftbukkit.inventory.CraftInventory inventory = new org.bukkit.craftbukkit.inventory.CraftInventoryAnvil(h, g);
