...
public class ContainerHorse extends Container {
	...
	public InventoryView getBukkitView() {
		...
		CraftInventory inventory = new org.bukkit.craftbukkit.inventory.CraftInventoryHorse(a);
	...
	public boolean a(EntityHuman entityhuman) {
		return a.a(entityhuman) && f.isAlive() && f.e(entityhuman) < 8.0F;
	}
	...
	public ItemStack b(EntityHuman entityhuman, int i) {
		...
		if (slot != null && slot.hasItem()) {
			...
			if (i < a.getSize()) {
				if (!this.a(itemstack1, a.getSize(), c.size(), true))
					return null;
				...
				if (!this.a(itemstack1, 0, 1, false))
					return null;
			} else if (a.getSize() <= 2 || !this.a(itemstack1, 2, a.getSize(), false))
				return null;
