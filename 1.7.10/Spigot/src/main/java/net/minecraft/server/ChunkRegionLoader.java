...
public class ChunkRegionLoader implements IChunkLoader, IAsyncChunkSaver {
	...
	public boolean chunkExists(World world, int i, int j) {
		...
		return RegionFileCache.a(e, i, j).chunkExists(i & 31, j & 31);
	}
	...
	public Object[] loadChunk(World world, int i, int j) {
		...
		if (nbttagcompound == null) {
			DataInputStream datainputstream = RegionFileCache.c(e, i, j);
	...
	protected void a(ChunkCoordIntPair chunkcoordintpair, NBTTagCompound nbttagcompound) {
		...
		synchronized (d) {
			// Spigot start
			if (pendingSaves.put(chunkcoordintpair, new PendingChunkToSave(chunkcoordintpair, nbttagcompound)) != null)
				return;
			// Spigot end
	...
	public boolean c() {
		...
		synchronized (d) {
			...
			pendingchunktosave = pendingSaves.values().iterator().next();
			pendingSaves.remove(pendingchunktosave.a);
			// Spigot end
		}
	...
	public void a(PendingChunkToSave pendingchunktosave) throws java.io.IOException { // CraftBukkit - public -> private, added throws
		DataOutputStream dataoutputstream = RegionFileCache.d(e, pendingchunktosave.a.x, pendingchunktosave.a.z);
