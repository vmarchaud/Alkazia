...
public enum Material {
    ...
    DARK_OAK_FENCE(191),
    ACACIA_FENCE(192),
    SPRUCE_DOOR_BLOCK(193, 64),
    BIRCH_DOOR_BLOCK(194, 64),
    JUNGLE_DOOR_BLOCK(195, 64),
    ACACIA_DOOR_BLOCK(196, 64),
    DARK_OAK_DOOR_BLOCK(197, 64),
    
    RAW_MUTTON(42, 643),
    COOKED_MUTTON(424, 64),
    SPRUCE_DOOR(427, 64),
    BIRCH_DOOR(428, 64),
    JUNGLE_DOOR(429, 64),
    ACACIA_DOOR(430, 64),
    DARK_OAK_DOOR(431, 64),
    // ClipSpigot end
    ...
    /** -->Alkazia */
    BAUXITE_HELMET(450, 1, 440),
    BAUXITE_CHESTPLATE(451, 1, 640),
    BAUXITE_LEGGINGS(452, 1, 600),
    BAUXITE_BOOTS(453, 1, 520),
    GRANITE_HELMET(454, 1, 440),
    GRANITE_CHESTPLATE(455, 1, 640),
    GRANITE_LEGGINGS(456, 1, 600),
    GRANITE_BOOTS(457, 1, 520),
    OPALE_HELMET(458, 1, 440),
    OPALE_CHESTPLATE(459, 1, 640),
    OPALE_LEGGINGS(460, 1, 600),
    OPALE_BOOTS(461, 1, 520),
    METEOR_HELMET(462, 1, 440),
    METEOR_CHESTPLATE(463, 1, 640),
    METEOR_LEGGINGS(464, 1, 600),
    METEOR_BOOTS(465, 1, 520),
    NINJA_HELMET(466, 1, 440),
    NINJA_CHESTPLATE(467, 1, 640),
    NINJA_LEGGINGS(468, 1, 600),
    NINJA_BOOTS(469, 1, 520),
    
    BAUXITE_SWORD(470, 1, 2000),
    BAUXITE_SPADE(471, 1, 2000),
    BAUXITE_PICKAXE(472, 1, 2000),
    BAUXITE_AXE(473, 1, 2000),
    BAUXITE_HOE(474, 1, 2000),
    
    GRANITE_SWORD(475, 1, 2000),
    GRANITE_SPADE(476, 1, 2000),
    GRANITE_PICKAXE(477, 1, 2000),
    GRANITE_AXE(478, 1, 2000),
    GRANITE_HOE(479, 1, 2000),
    
    OPALE_SWORD(480, 1, 2000),
    OPALE_SPADE(481, 1, 2000),
    OPALE_PICKAXE(482, 1, 2000),
    OPALE_AXE(483, 1, 2000),
    OPALE_HOE(484, 1, 2000),
    
    METEOR_SWORD(485, 1, 2000),
    METEOR_SPADE(486, 1, 2000),
    METEOR_PICKAXE(487, 1, 2000),
    METEOR_AXE(488, 1, 2000),
    METEOR_HOE(489, 1, 2000),
    
    BAUXITE_BOW(490, 1, 450),
    GRANITE_BOW(491, 1, 550),
    OPALE_BOW(492, 1, 650),
    METEOR_BOW(493, 1, 800),
    ...
    DRINK_STUFF(505,1),
    HASTE_POTION(506,1),
    HASTE_POTION_2(507,1),
    RESISTANCE_POTION(508,1),
    RESISTANCE_POTION_2(509,1),
    JUMP_POTION(510,1),
    JUMP_POTION_2(511,1),
    ...
    METEOR_BLOCK(207),
    POUSSE(208),
    IRON_CHEST(209, IronChest.class),
    METEORITE(210),
    INVISIBLE(211),
    LUMIERE(213),
    ANDESITE(214),
