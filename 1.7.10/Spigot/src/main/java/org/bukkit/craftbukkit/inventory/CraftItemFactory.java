...
public final class CraftItemFactory implements ItemFactory {
	...
	static {
		...
		KNOWN_NBT_ATTRIBUTE_NAMES = ImmutableSet.<String> builder().add("generic.attackDamage").add("generic.followRange").add("generic.knockbackResistance").add("generic.maxHealth").add("generic.movementSpeed").add("horse.jumpStrength").add("zombie.spawnReinforcements").build();
	}
