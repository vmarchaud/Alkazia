...
public class CraftBlock implements Block {
	...
	@Override
	public byte getData() {
		return (byte) chunk.getHandle().getData(x & 0xF, y & 0xFF, z & 0xF);
	}
	...
	public int getTypeId() {
		return CraftMagicNumbers.getId(chunk.getHandle().getType(x & 0xF, y & 0xFF, z & 0xF));
	}

	@Override
	public byte getLightLevel() {
		return (byte) chunk.getHandle().world.getLightLevel(x, y, z);
	}

	@Override
	public byte getLightFromSky() {
		return (byte) chunk.getHandle().getBrightness(EnumSkyBlock.SKY, x & 0xF, y & 0xFF, z & 0xF);
	}

	@Override
	public byte getLightFromBlocks() {
		return (byte) chunk.getHandle().getBrightness(EnumSkyBlock.BLOCK, x & 0xF, y & 0xFF, z & 0xF);
	}
