...
public class SpigotWorldConfig {
	...
	private void hoppers() {
		...
		if (prev != altHopperTicking) {
			net.minecraft.server.World world = (net.minecraft.server.World) Bukkit.getWorld(worldName);
			if (world != null) {
				if (altHopperTicking) {
	...
	private void antiXray() {
		...
		hiddenBlocks = getList("anti-xray.hide-blocks", Arrays.asList(new Integer[] { 14, 15, 16, 21, 48, 49, 54, 56, 73, 74, 82, 129, 130 }));
