...
public class ItemStackLoreEnchantmentTest extends ItemStackTest {
	...
	static List<Object[]> operators() {
		return CompoundOperator.compound(Joiner.on('+'), NAME_PARAMETER, ~0l, Arrays.asList(new Object[] { new Operator() {
			@Override
		...
		}, "Lore vs Null" }, new Object[] { new Operator() {
			@Override
			public ItemStack operate(ItemStack cleanStack) {
				ItemMeta meta = cleanStack.getItemMeta();
		...
		}, "Lore vs Blank" }, new Object[] { new Operator() {
			@Override
			public ItemStack operate(ItemStack cleanStack) {
				ItemMeta meta = cleanStack.getItemMeta();
		...
		}, "Lore vs Other" }), Arrays.asList(new Object[] { new Operator() {
			@Override
			public ItemStack operate(ItemStack cleanStack) {
				ItemMeta meta = cleanStack.getItemMeta();
		...
		}, "Name vs Null" }, new Object[] { new Operator() {
			@Override
			public ItemStack operate(ItemStack cleanStack) {
				ItemMeta meta = cleanStack.getItemMeta();
		...
		}, "Name vs Blank" }, new Object[] { new Operator() {
			@Override
			public ItemStack operate(ItemStack cleanStack) {
				ItemMeta meta = cleanStack.getItemMeta();
		...
		}, "Name vs Other" }), Arrays.asList(new Object[] { new Operator() {
			@Override
			public ItemStack operate(ItemStack cleanStack) {
		...
		}, "EnchantStack vs Null" }, new Object[] { new Operator() {
			@Override
			public ItemStack operate(ItemStack cleanStack) {
		...
		}, "EnchantStack vs Blank" }, new Object[] { new Operator() {
			@Override
			public ItemStack operate(ItemStack cleanStack) {
		...
		}, "EnchantStack vs OtherEnchantStack" }, new Object[] { new Operator() {
			@Override
			public ItemStack operate(ItemStack cleanStack) {
				ItemMeta meta = cleanStack.getItemMeta();
		...
		}, "Enchant vs Blank" }, new Object[] { new Operator() {
			@Override
			public ItemStack operate(ItemStack cleanStack) {
				ItemMeta meta = cleanStack.getItemMeta();
		...
		}, "Enchant vs Null" }, new Object[] { new Operator() {
			@Override
			public ItemStack operate(ItemStack cleanStack) {
				ItemMeta meta = cleanStack.getItemMeta();
		...
		}, "Enchant vs Other" }), Arrays.asList(new Object[] { new Operator() {
			@Override
			public ItemStack operate(ItemStack cleanStack) {
				ItemMeta meta = cleanStack.getItemMeta();
		...
		}, "Repair vs Null" }, new Object[] { new Operator() {
			@Override
			public ItemStack operate(ItemStack cleanStack) {
				ItemMeta meta = cleanStack.getItemMeta();
		...
		}, "Repair vs Blank" }, new Object[] { new Operator() {
			@Override
			public ItemStack operate(ItemStack cleanStack) {
				ItemMeta meta = cleanStack.getItemMeta();
