...
public class ItemStackFireworkTest extends ItemStackTest {
	...
	static List<Object[]> operators() {
		return CompoundOperator.compound(Joiner.on('+'), NAME_PARAMETER, Long.parseLong("110", 2), ItemStackLoreEnchantmentTest.operators(), Arrays.asList(new Object[] { new Operator() {
			@Override
		...
		}, "Effect Color 1 vs. Effect Color 2" }, new Object[] { new Operator() {
			@Override
			public ItemStack operate(ItemStack cleanStack) {
				FireworkMeta meta = (FireworkMeta) cleanStack.getItemMeta();
		...
		}, "Effect type 1 vs. Effect type 2" }, new Object[] { new Operator() {
			@Override
			public ItemStack operate(ItemStack cleanStack) {
				FireworkMeta meta = (FireworkMeta) cleanStack.getItemMeta();
		...
		}, "Effect fade 1 vs. Effect fade 2" }, new Object[] { new Operator() {
			@Override
			public ItemStack operate(ItemStack cleanStack) {
				FireworkMeta meta = (FireworkMeta) cleanStack.getItemMeta();
		...
		}, "Effect vs. Null" }, new Object[] { new Operator() {
			@Override
			public ItemStack operate(ItemStack cleanStack) {
				FireworkMeta meta = (FireworkMeta) cleanStack.getItemMeta();
		...
		}, "Effect vs. None" }), Arrays.asList(new Object[] { new Operator() {
			@Override
			public ItemStack operate(ItemStack cleanStack) {
				FireworkMeta meta = (FireworkMeta) cleanStack.getItemMeta();
				meta.setPower(127);
		...
		}, "Height vs. Other" }, new Object[] { new Operator() {
			@Override
			public ItemStack operate(ItemStack cleanStack) {
				FireworkMeta meta = (FireworkMeta) cleanStack.getItemMeta();
				meta.setPower(42);
		...
		}, "Height vs. Null" }, new Object[] { new Operator() {
			@Override
			public ItemStack operate(ItemStack cleanStack) {
				FireworkMeta meta = (FireworkMeta) cleanStack.getItemMeta();
				meta.setPower(10);
