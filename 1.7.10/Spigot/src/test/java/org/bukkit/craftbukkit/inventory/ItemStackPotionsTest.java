...
public class ItemStackPotionsTest extends ItemStackTest {
	...
	static List<Object[]> operators() {
		...
		}, "Potion vs Null" }, new Object[] { new Operator() {
			@Override
			public ItemStack operate(ItemStack cleanStack) {
				final PotionMeta meta = (PotionMeta) cleanStack.getItemMeta();
		...
		}, "Potion vs Blank" }, new Object[] { new Operator() {
			@Override
			public ItemStack operate(ItemStack cleanStack) {
				final PotionMeta meta = (PotionMeta) cleanStack.getItemMeta();
		...
		}, "Potion vs Harder" }, new Object[] { new Operator() {
			@Override
			public ItemStack operate(ItemStack cleanStack) {
				final PotionMeta meta = (PotionMeta) cleanStack.getItemMeta();
		...
		}, "Potion vs Better" }, new Object[] { new Operator() {
			@Override
			public ItemStack operate(ItemStack cleanStack) {
				final PotionMeta meta = (PotionMeta) cleanStack.getItemMeta();
		...
		}, "Potion vs Faster" }, new Object[] { new Operator() {
			@Override
			public ItemStack operate(ItemStack cleanStack) {
				final PotionMeta meta = (PotionMeta) cleanStack.getItemMeta();
