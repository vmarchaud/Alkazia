...
public class EnchantmentProtection extends Enchantment
{
    ...
    public int calcModifierDamage(int p_77318_1_, DamageSource p_77318_2_)
    {
        ...
        else
        {
            ...
            return this.protectionType == 0 ? MathHelper.floor_float(var3 * 0.95F) : // Alkazia - try to fix protection enchantment
            	(this.protectionType == 1 && p_77318_2_.isFireDamage() ? MathHelper.floor_float(var3 * 1.25F) :
            		(this.protectionType == 2 && p_77318_2_ == DamageSource.fall ? MathHelper.floor_float(var3 * 2.5F) : 
            			(this.protectionType == 3 && p_77318_2_.isExplosion() ? MathHelper.floor_float(var3 * 1.5F) : 
            				(this.protectionType == 4 && p_77318_2_.isProjectile() ? MathHelper.floor_float(var3 * 1.5F) : 0))));
        }
    }
