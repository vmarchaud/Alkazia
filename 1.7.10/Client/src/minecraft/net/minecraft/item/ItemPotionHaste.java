...
public class ItemPotionHaste extends Item
{
    ...
    public ItemStack onEaten(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        if (!par2World.isClient)
        {
            if(this.meta == 0) {
            	...
            	par3EntityPlayer.addPotionEffect(new PotionEffect(Potion.digSpeed.id, 2400, 0));
            }
        }
    ...
    {
    	if(this.meta == 0) {
        	p_77624_3_.add(EnumChatFormatting.GRAY + "Haste (4:00)");
            p_77624_3_.add("");
            p_77624_3_.add(EnumChatFormatting.DARK_PURPLE + StatCollector.translateToLocal("potion.effects.whenDrank"));
            p_77624_3_.add(EnumChatFormatting.BLUE + StatCollector.translateToLocal("+20% Mining Speed"));
    	}
    	else if(this.meta == 1) {
        	p_77624_3_.add(EnumChatFormatting.GRAY + "Haste II (2:00)");
            p_77624_3_.add("");
            p_77624_3_.add(EnumChatFormatting.DARK_PURPLE + StatCollector.translateToLocal("potion.effects.whenDrank"));
            p_77624_3_.add(EnumChatFormatting.BLUE + StatCollector.translateToLocal("+40% Mining Speed"));
    	}
