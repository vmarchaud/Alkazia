...
public class Item
{
    ...
    public static void registerItems()
    {
     ...
     // Alkazia V1
        itemRegistry.addObject(450, "bauxite_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.BAUXITE, 5, 0)).setUnlocalizedName("helmetBauxite").setTextureName("bauxite_helmet"));
        itemRegistry.addObject(451, "bauxite_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.BAUXITE, 5, 1)).setUnlocalizedName("chestplateBauxite").setTextureName("bauxite_chestplate"));
        itemRegistry.addObject(452, "bauxite_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.BAUXITE, 5, 2)).setUnlocalizedName("leggingsBauxite").setTextureName("bauxite_leggings"));
        itemRegistry.addObject(453, "bauxite_boots", (new ItemArmor(ItemArmor.ArmorMaterial.BAUXITE, 5, 3)).setUnlocalizedName("bootsBauxite").setTextureName("bauxite_boots"));
        
        itemRegistry.addObject(454, "granite_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.GRANITE, 6, 0)).setUnlocalizedName("helmetGranite").setTextureName("granite_helmet"));
        itemRegistry.addObject(455, "granite_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.GRANITE, 6, 1)).setUnlocalizedName("chestplateGranite").setTextureName("granite_chestplate"));
        itemRegistry.addObject(456, "granite_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.GRANITE, 6, 2)).setUnlocalizedName("leggingsGranite").setTextureName("granite_leggings"));
        itemRegistry.addObject(457, "granite_boots", (new ItemArmor(ItemArmor.ArmorMaterial.GRANITE, 6, 3)).setUnlocalizedName("bootsGranite").setTextureName("granite_boots"));
        
        itemRegistry.addObject(458, "opale_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.OPALE, 7, 0)).setUnlocalizedName("helmetOpale").setTextureName("opale_helmet"));
        itemRegistry.addObject(459, "opale_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.OPALE, 7, 1)).setUnlocalizedName("chestplateOpale").setTextureName("opale_chestplate"));
        itemRegistry.addObject(460, "opale_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.OPALE, 7, 2)).setUnlocalizedName("leggingsOpale").setTextureName("opale_leggings"));
        itemRegistry.addObject(461, "opale_boots", (new ItemArmor(ItemArmor.ArmorMaterial.OPALE, 7, 3)).setUnlocalizedName("bootsOpale").setTextureName("opale_boots"));
        
        itemRegistry.addObject(462, "meteor_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.METEOR, 8, 0)).setUnlocalizedName("helmetMeteor").setTextureName("meteor_helmet"));
        itemRegistry.addObject(463, "meteor_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.METEOR, 8, 1)).setUnlocalizedName("chestplateMeteor").setTextureName("meteor_chestplate"));
        itemRegistry.addObject(464, "meteor_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.METEOR, 8, 2)).setUnlocalizedName("leggingsMeteor").setTextureName("meteor_leggings"));
        itemRegistry.addObject(465, "meteor_boots", (new ItemArmor(ItemArmor.ArmorMaterial.METEOR, 8, 3)).setUnlocalizedName("bootsMeteor").setTextureName("meteor_boots"));
        
        itemRegistry.addObject(466, "ninja_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.NINJA, 9, 0)).setUnlocalizedName("helmetNinja").setTextureName("ninja_helmet"));
        itemRegistry.addObject(467, "ninja_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.NINJA, 9, 1)).setUnlocalizedName("chestplateNinja").setTextureName("ninja_chestplate"));
        itemRegistry.addObject(468, "ninja_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.NINJA, 9, 2)).setUnlocalizedName("leggingsNinja").setTextureName("ninja_leggings"));
        itemRegistry.addObject(469, "ninja_boots", (new ItemArmor(ItemArmor.ArmorMaterial.NINJA, 9, 3)).setUnlocalizedName("bootsNinja").setTextureName("ninja_boots"));
        
        itemRegistry.addObject(470, "bauxite_sword", (new ItemSword(Item.ToolMaterial.BAUXITE)).setUnlocalizedName("swordBauxite").setTextureName("bauxite_sword"));
        itemRegistry.addObject(471, "bauxite_shovel", (new ItemSpade(Item.ToolMaterial.BAUXITE)).setUnlocalizedName("shovelBauxite").setTextureName("bauxite_shovel"));
        itemRegistry.addObject(472, "bauxite_pickaxe", (new ItemPickaxe(Item.ToolMaterial.BAUXITE)).setUnlocalizedName("pickaxeBauxite").setTextureName("bauxite_pickaxe"));
        itemRegistry.addObject(473, "bauxite_axe", (new ItemAxe(Item.ToolMaterial.BAUXITE)).setUnlocalizedName("hatchetBauxite").setTextureName("bauxite_axe"));
        itemRegistry.addObject(474, "bauxite_hoe", (new ItemHoe(Item.ToolMaterial.BAUXITE)).setUnlocalizedName("hoeBauxite").setTextureName("bauxite_hoe"));
        
        itemRegistry.addObject(475, "granite_sword", (new ItemSword(Item.ToolMaterial.GRANITE)).setUnlocalizedName("swordGranite").setTextureName("granite_sword"));
        itemRegistry.addObject(476, "granite_shovel", (new ItemSpade(Item.ToolMaterial.GRANITE)).setUnlocalizedName("shovelGranite").setTextureName("granite_shovel"));
        itemRegistry.addObject(477, "granite_pickaxe", (new ItemPickaxe(Item.ToolMaterial.GRANITE)).setUnlocalizedName("pickaxeGranite").setTextureName("granite_pickaxe"));
        itemRegistry.addObject(478, "granite_axe", (new ItemAxe(Item.ToolMaterial.GRANITE)).setUnlocalizedName("hatchetGranite").setTextureName("granite_axe"));
        itemRegistry.addObject(479, "granite_hoe", (new ItemHoe(Item.ToolMaterial.GRANITE)).setUnlocalizedName("hoeGranite").setTextureName("granite_hoe"));
        
        itemRegistry.addObject(480, "opale_sword", (new ItemSword(Item.ToolMaterial.OPALE)).setUnlocalizedName("swordOpale").setTextureName("opale_sword"));
        itemRegistry.addObject(481, "opale_shovel", (new ItemSpade(Item.ToolMaterial.OPALE)).setUnlocalizedName("shovelOpale").setTextureName("opale_shovel"));
        itemRegistry.addObject(482, "opale_pickaxe", (new ItemPickaxe(Item.ToolMaterial.OPALE)).setUnlocalizedName("pickaxeOpale").setTextureName("opale_pickaxe"));
        itemRegistry.addObject(483, "opale_axe", (new ItemAxe(Item.ToolMaterial.OPALE)).setUnlocalizedName("hatchetOpale").setTextureName("opale_axe"));
        itemRegistry.addObject(484, "opale_hoe", (new ItemHoe(Item.ToolMaterial.OPALE)).setUnlocalizedName("hoeOpale").setTextureName("opale_hoe"));
        
        itemRegistry.addObject(485, "meteor_sword", (new ItemSword(Item.ToolMaterial.METEOR)).setUnlocalizedName("swordMeteor").setTextureName("meteor_sword"));
        itemRegistry.addObject(486, "meteor_shovel", (new ItemSpade(Item.ToolMaterial.METEOR)).setUnlocalizedName("shovelMeteor").setTextureName("meteor_shovel"));
        itemRegistry.addObject(487, "meteor_pickaxe", (new ItemPickaxe(Item.ToolMaterial.METEOR)).setUnlocalizedName("pickaxeMeteor").setTextureName("meteor_pickaxe"));
        itemRegistry.addObject(488, "meteor_axe", (new ItemAxe(Item.ToolMaterial.METEOR)).setUnlocalizedName("hatchetMeteor").setTextureName("meteor_axe"));
        itemRegistry.addObject(489, "meteor_hoe", (new ItemHoe(Item.ToolMaterial.METEOR)).setUnlocalizedName("hoeMeteor").setTextureName("meteor_hoe"));
        
        itemRegistry.addObject(490, "bowBauxite", (new ItemBowBauxite()).setUnlocalizedName("bowBauxite").setTextureName("bowBauxite"));
        itemRegistry.addObject(491, "bowGranite", (new ItemBowGranite()).setUnlocalizedName("bowGranite").setTextureName("bowGranite"));
        itemRegistry.addObject(492, "bowOpale", (new ItemBowOpale()).setUnlocalizedName("bowOpale").setTextureName("bowOpale"));
        itemRegistry.addObject(493, "bowMeteor", (new ItemBowMeteor()).setUnlocalizedName("bowMeteor").setTextureName("bowMeteor"));
        
        itemRegistry.addObject(495, "bauxite_ingot", (new Item()).setUnlocalizedName("ingotBauxite").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("bauxite_ingot"));
        itemRegistry.addObject(496, "granite", (new Item()).setUnlocalizedName("granite").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("granite"));
        itemRegistry.addObject(497, "opale", (new Item()).setUnlocalizedName("opale").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("opale"));
        itemRegistry.addObject(498, "meteor_fragment", (new Item()).setUnlocalizedName("fragmentMeteor").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("meteor_ingot"));
        itemRegistry.addObject(499, "milkPotion", (new ItemPotionMilk()).setUnlocalizedName("milkPotion").setContainerItem(var0).setTextureName("potionMilk"));
        itemRegistry.addObject(500, "stuff", (new ItemChocolate(4, 4.0F, false)).setAlwaysEdible().setUnlocalizedName("stuff").setTextureName("candyCane"));
        itemRegistry.addObject(501, "ninjaPowder", (new Item()).setUnlocalizedName("ninjaPowder").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("ninjaPowder"));
        // Alkazia V2
        itemRegistry.addObject(502, "sheep", (new ItemFood(3, 0.3F, true)).setUnlocalizedName("sheepRaw").setTextureName("sheep_raw"));
        itemRegistry.addObject(503, "cooked_sheep", (new ItemFood(8, 0.8F, true)).setUnlocalizedName("sheepCooked").setTextureName("sheep_cooked"));
        itemRegistry.addObject(504, "fallPotion", (new ItemPotionFall()).setUnlocalizedName("fallPotion").setContainerItem(var0).setTextureName("potionFall"));
        
        // Alkazia - V4

        itemRegistry.addObject(505, "drinkStuff", (new ItemDrinkableStuff()).setUnlocalizedName("drinkableStuff").setTextureName("hotChocolate"));
        
        itemRegistry.addObject(506, "potionHaste", (new ItemPotionHaste(0)).setUnlocalizedName("potionHaste").setContainerItem(var0).setTextureName("potionHaste"));
        itemRegistry.addObject(507, "potionHaste2", (new ItemPotionHaste(1)).setUnlocalizedName("potionHaste2").setContainerItem(var0).setTextureName("potionHaste"));
        itemRegistry.addObject(508, "potionResistance", (new ItemPotionResistance(0)).setUnlocalizedName("potionResistance").setContainerItem(var0).setTextureName("potionResistance"));
        itemRegistry.addObject(509, "potionResistance2", (new ItemPotionResistance(1)).setUnlocalizedName("potionResistance2").setContainerItem(var0).setTextureName("potionResistance"));
        itemRegistry.addObject(510, "potionJump", (new ItemPotionJump(0)).setUnlocalizedName("potionJump").setContainerItem(var0).setTextureName("potionJump"));
        itemRegistry.addObject(511, "potionJump2", (new ItemPotionJump(1)).setUnlocalizedName("potionJump2").setContainerItem(var0).setTextureName("potionJump"));
    ...
    public static enum ToolMaterial
    {
        ...
        BAUXITE("BAUXITE", 5, 2, 900, 7.0F, 4, 14),
        GRANITE("GRANITE", 6, 3, 2000, 11.0F, 5, 10),
        OPALE("OPALE", 7, 3, 3000, 13.0F, 6, 10),
        METEOR("METEOR", 7, 3, 3600, 15.0F, 7, 10);
