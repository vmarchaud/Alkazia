...
public class RecipesIngots
{
    ...
    {
    	/** Alkazia */
        this.recipeItems = new Object[][] {{Blocks.gold_block, new ItemStack(Items.gold_ingot, 9)}, {Blocks.iron_block, new ItemStack(Items.iron_ingot, 9)}, {Blocks.diamond_block, new ItemStack(Items.diamond, 9)}, {Blocks.emerald_block, new ItemStack(Items.emerald, 9)}, {Blocks.lapis_block, new ItemStack(Items.dye, 9, 4)}, {Blocks.redstone_block, new ItemStack(Items.redstone, 9)}, {Blocks.coal_block, new ItemStack(Items.coal, 9, 0)}, {Blocks.hay_block, new ItemStack(Items.wheat, 9)}, {Blocks.bauxite_block, new ItemStack(Items.bauxite_ingot, 9, 0)}, {Blocks.granite_block, new ItemStack(Items.granite, 9, 0)}, {Blocks.opale_block, new ItemStack(Items.opale, 9, 0)}, {Blocks.meteor_block, new ItemStack(Items.meteor_fragment, 9, 0)}};
    }
