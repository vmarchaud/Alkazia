...
public class Blocks
{
    ...
    // Alkazia - Register new block - V1 -
    public static final Block bauxite_ore = (Block)Block.blockRegistry.getObject("bauxite_ore");
    public static final Block granite_ore = (Block)Block.blockRegistry.getObject("granite_ore");
    public static final Block opale_ore = (Block)Block.blockRegistry.getObject("opale_ore");
    public static final Block meteor_ore = (Block)Block.blockRegistry.getObject("meteor_ore");
    
    public static final Block bauxite_block = (Block)Block.blockRegistry.getObject("bauxite_block");
    public static final Block granite_block = (Block)Block.blockRegistry.getObject("granite_block");
    public static final Block opale_block = (Block)Block.blockRegistry.getObject("opale_block");
    public static final Block meteor_block = (Block)Block.blockRegistry.getObject("meteor_block");
    
    public static final Block pousse = (Block)Block.blockRegistry.getObject("pousse");
    public static final BlockIronChest iron_chest = (BlockIronChest)Block.blockRegistry.getObject("iron_chest");
    public static final Block meteorite = (Block)Block.blockRegistry.getObject("meteorite");
    public static final Block invisible = (Block)Block.blockRegistry.getObject("invisible");
    //public static final Block invisible_door = (Block)Block.blockRegistry.getObject("invisible_door");
    public static final Block lumiere = (Block)Block.blockRegistry.getObject("lumiere");

    // Alkazia - Register new block - V2 -
    
    public static final Block andesite = (Block)Block.blockRegistry.getObject("andesite");
    public static final Block andesite_smooth = (Block)Block.blockRegistry.getObject("andesite_smooth");
    public static final Block alumite = (Block)Block.blockRegistry.getObject("alumite");
    public static final Block alumite_smooth = (Block)Block.blockRegistry.getObject("alumite_smooth");
    public static final Block diorite = (Block)Block.blockRegistry.getObject("diorite");
    public static final Block diorite_smooth = (Block)Block.blockRegistry.getObject("diorite_smooth");
    public static final Block ironLadder = (Block)Block.blockRegistry.getObject("ironLadder");
    public static final Block powderBlock = (Block)Block.blockRegistry.getObject("powderBlock");
    
    // Alkazia - V3 bitch

    public static final Block fakub = (Block)Block.blockRegistry.getObject("fakub");
    public static final Block fakub_off = (Block)Block.blockRegistry.getObject("fakub_off");
    
    // Alkazia - V4

    public static final Block presentBlock = (Block)Block.blockRegistry.getObject("presentBlock");
    public static final Block starBlock = (Block)Block.blockRegistry.getObject("starBlock");
