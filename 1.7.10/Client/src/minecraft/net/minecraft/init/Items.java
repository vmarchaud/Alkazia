...
public class Items
{
 ...
 // Alkazia V1
    public static final ItemArmor bauxite_helmet = (ItemArmor)Item.itemRegistry.getObject("bauxite_helmet");
    public static final ItemArmor bauxite_chestplate = (ItemArmor)Item.itemRegistry.getObject("bauxite_chestplate");
    public static final ItemArmor bauxite_leggings = (ItemArmor)Item.itemRegistry.getObject("bauxite_leggings");
    public static final ItemArmor bauxite_boots = (ItemArmor)Item.itemRegistry.getObject("bauxite_boots");
    public static final ItemArmor granite_helmet = (ItemArmor)Item.itemRegistry.getObject("granite_helmet");
    public static final ItemArmor granite_chestplate = (ItemArmor)Item.itemRegistry.getObject("granite_chestplate");
    public static final ItemArmor granite_leggings = (ItemArmor)Item.itemRegistry.getObject("granite_leggings");
    public static final ItemArmor granite_boots = (ItemArmor)Item.itemRegistry.getObject("granite_boots");
    public static final ItemArmor opale_helmet = (ItemArmor)Item.itemRegistry.getObject("opale_helmet");
    public static final ItemArmor opale_chestplate = (ItemArmor)Item.itemRegistry.getObject("opale_chestplate");
    public static final ItemArmor opale_leggings = (ItemArmor)Item.itemRegistry.getObject("opale_leggings");
    public static final ItemArmor opale_boots = (ItemArmor)Item.itemRegistry.getObject("opale_boots");
    public static final ItemArmor meteor_helmet = (ItemArmor)Item.itemRegistry.getObject("meteor_helmet");
    public static final ItemArmor meteor_chestplate = (ItemArmor)Item.itemRegistry.getObject("meteor_chestplate");
    public static final ItemArmor meteor_leggings = (ItemArmor)Item.itemRegistry.getObject("meteor_leggings");
    public static final ItemArmor meteor_boots = (ItemArmor)Item.itemRegistry.getObject("meteor_boots");
    public static final ItemArmor ninja_helmet = (ItemArmor)Item.itemRegistry.getObject("ninja_helmet");
    public static final ItemArmor ninja_chestplate = (ItemArmor)Item.itemRegistry.getObject("ninja_chestplate");
    public static final ItemArmor ninja_leggings = (ItemArmor)Item.itemRegistry.getObject("ninja_leggings");
    public static final ItemArmor ninja_boots = (ItemArmor)Item.itemRegistry.getObject("ninja_boots");
    
    public static final Item bauxite_sword = (Item)Item.itemRegistry.getObject("bauxite_sword");
    public static final Item bauxite_shovel = (Item)Item.itemRegistry.getObject("bauxite_shovel");
    public static final Item bauxite_pickaxe = (Item)Item.itemRegistry.getObject("bauxite_pickaxe");
    public static final Item bauxite_axe = (Item)Item.itemRegistry.getObject("bauxite_axe");
    public static final Item bauxite_hoe = (Item)Item.itemRegistry.getObject("bauxite_hoe");
    public static final Item granite_sword = (Item)Item.itemRegistry.getObject("granite_sword");
    public static final Item granite_shovel = (Item)Item.itemRegistry.getObject("granite_shovel");
    public static final Item granite_pickaxe = (Item)Item.itemRegistry.getObject("granite_pickaxe");
    public static final Item granite_axe = (Item)Item.itemRegistry.getObject("granite_axe");
    public static final Item granite_hoe = (Item)Item.itemRegistry.getObject("granite_hoe");
    public static final Item opale_sword = (Item)Item.itemRegistry.getObject("opale_sword");
    public static final Item opale_shovel = (Item)Item.itemRegistry.getObject("opale_shovel");
    public static final Item opale_pickaxe = (Item)Item.itemRegistry.getObject("opale_pickaxe");
    public static final Item opale_axe = (Item)Item.itemRegistry.getObject("opale_axe");
    public static final Item opale_hoe = (Item)Item.itemRegistry.getObject("opale_hoe");
    public static final Item meteor_sword = (Item)Item.itemRegistry.getObject("meteor_sword");
    public static final Item meteor_shovel = (Item)Item.itemRegistry.getObject("meteor_shovel");
    public static final Item meteor_pickaxe = (Item)Item.itemRegistry.getObject("meteor_pickaxe");
    public static final Item meteor_axe = (Item)Item.itemRegistry.getObject("meteor_axe");
    public static final Item meteor_hoe = (Item)Item.itemRegistry.getObject("meteor_hoe");
    
    public static final ItemBowBauxite bowBauxite = (ItemBowBauxite)Item.itemRegistry.getObject("bowBauxite");
    public static final ItemBowGranite bowGranite = (ItemBowGranite)Item.itemRegistry.getObject("bowGranite");
    public static final ItemBowOpale bowOpale = (ItemBowOpale)Item.itemRegistry.getObject("bowOpale");
    public static final ItemBowMeteor bowMeteor = (ItemBowMeteor)Item.itemRegistry.getObject("bowMeteor");
    
    public static final Item bauxite_ingot = (Item)Item.itemRegistry.getObject("bauxite_ingot");
    public static final Item granite = (Item)Item.itemRegistry.getObject("granite");
    public static final Item opale = (Item)Item.itemRegistry.getObject("opale");
    public static final Item meteor_fragment = (Item)Item.itemRegistry.getObject("meteor_fragment");
    public static final Item potionMilk = (Item)Item.itemRegistry.getObject("milkPotion");
    public static final Item stuff = (Item)Item.itemRegistry.getObject("stuff");
    public static final Item ninjaPowder = (Item)Item.itemRegistry.getObject("ninjaPowder");
    
    // Alkazia V2
    
    public static final Item sheep = (Item)Item.itemRegistry.getObject("sheep");
    public static final Item cooked_sheep = (Item)Item.itemRegistry.getObject("cooked_sheep");
    public static final Item potionFall = (Item)Item.itemRegistry.getObject("fallPotion");
    
    // V4

    public static final Item potionHaste = (Item)Item.itemRegistry.getObject("potionHaste");
    public static final Item potionResistance = (Item)Item.itemRegistry.getObject("potionResistance");
    public static final Item potionJump = (Item)Item.itemRegistry.getObject("potionJump");
    
    public static final Item potionHaste2 = (Item)Item.itemRegistry.getObject("potionHaste2");
    public static final Item potionResistance2 = (Item)Item.itemRegistry.getObject("potionResistance2");
    public static final Item potionJump2 = (Item)Item.itemRegistry.getObject("potionJump2");
