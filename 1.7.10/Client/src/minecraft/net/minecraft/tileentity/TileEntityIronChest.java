...
public class TileEntityIronChest extends TileEntity implements IInventory
{
    ...
    public TileEntityIronChest field_145992_i;
    public TileEntityIronChest field_145990_j;
    public TileEntityIronChest field_145991_k;
    public TileEntityIronChest field_145988_l;
    ...
    public TileEntityIronChest(int par1)
    {
    	field_145985_p = new ItemStack[54];
    ...
    private void func_145978_a(TileEntityIronChest p_145978_1_, int p_145978_2_)
    {
    ...
    private boolean func_145977_a(int p_145977_1_, int p_145977_2_, int p_145977_3_)
    {
        ...
        return var4 instanceof BlockIronChest && ((BlockIronChest)var4).field_149956_a == this.func_145980_j();
    }
    ...
    {
        if (this.getBlockType() instanceof BlockIronChest)
        {
            --this.field_145987_o;
            this.worldObj.func_147452_c(this.field_145851_c, this.field_145848_d, this.field_145849_e, this.getBlockType(), 1, this.field_145987_o);
            this.worldObj.notifyBlocksOfNeighborChange(this.field_145851_c, this.field_145848_d, this.field_145849_e, this.getBlockType());
    ...
    public int func_145980_j()
    {
        ...
        {
            if (this.worldObj == null || !(this.getBlockType() instanceof BlockIronChest))
            {
                return 0;
            }

            this.field_145982_r = ((BlockIronChest)this.getBlockType()).field_149956_a;
        }
