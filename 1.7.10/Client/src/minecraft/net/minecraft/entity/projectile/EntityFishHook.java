...
public class EntityFishHook extends Entity
{
	private static final List field_146039_d = Arrays.asList(new WeightedRandomFishable[] 
    		{(new WeightedRandomFishable(new ItemStack(Items.dye, 3, 0), 10)),
    		new WeightedRandomFishable(new ItemStack(Items.melon_seeds), 10),
    		new WeightedRandomFishable(new ItemStack(Blocks.pousse), 10), 
    		new WeightedRandomFishable(new ItemStack(Items.potionitem), 10),
    		new WeightedRandomFishable(new ItemStack(Items.bauxite_ingot), 5),
    		(new WeightedRandomFishable(new ItemStack(Items.fishing_rod), 2)).func_150709_a(0.9F),
    		new WeightedRandomFishable(new ItemStack(Items.gold_nugget), 10),
    		new WeightedRandomFishable(new ItemStack(Items.saddle), 5),
    		new WeightedRandomFishable(new ItemStack(Items.dye, 10, 0), 1),
    		new WeightedRandomFishable(new ItemStack(Items.book), 1),
    		new WeightedRandomFishable(new ItemStack(Items.name_tag), 10)});
    
    private static final List field_146041_e = Arrays.asList(new WeightedRandomFishable[] 
    		{new WeightedRandomFishable(new ItemStack(Items.record_wait), 1),
    		new WeightedRandomFishable(new ItemStack(Items.record_cat), 1),
    		new WeightedRandomFishable(new ItemStack(Items.record_far), 1),
    		(new WeightedRandomFishable(new ItemStack(Items.record_stal), 1)), 
    		(new WeightedRandomFishable(new ItemStack(Items.record_blocks), 1)),
    		(new WeightedRandomFishable(new ItemStack(Items.record_mellohi), 1))});
    
    private static final List field_146036_f = Arrays.asList(new WeightedRandomFishable[] 
    		{new WeightedRandomFishable(new ItemStack(Items.fish, 1, ItemFishFood.FishType.COD.func_150976_a()), 30),
    		new WeightedRandomFishable(new ItemStack(Items.fish, 1, ItemFishFood.FishType.SALMON.func_150976_a()), 20),
    		new WeightedRandomFishable(new ItemStack(Items.fish, 1, ItemFishFood.FishType.CLOWNFISH.func_150976_a()), 25),
    		new WeightedRandomFishable(new ItemStack(Items.fish, 1, ItemFishFood.FishType.PUFFERFISH.func_150976_a()), 20),
    		new WeightedRandomFishable(new ItemStack(Items.fish, 1, ItemFishFood.FishType.NINJAFISH.func_150976_a()), 30)});
