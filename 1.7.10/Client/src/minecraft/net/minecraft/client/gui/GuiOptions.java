...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        //this.buttonList.add(new GuiButton(107, this.width / 2 + 5, this.height / 6 + 72 - 6, 150, 20, I18n.format("Shaders", new Object[0])));
    ...
    protected void actionPerformed(GuiButton p_146284_1_)
    {
        if (p_146284_1_.enabled)
        {
            ...
            {
                this.mc.gameSettings.saveOptions();
                //this.mc.displayGuiScreen(new GuiShaders(field_146441_g, this.field_146443_h));
            }
        }
    }
