...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float p_73830_1_, boolean p_73830_2_, int p_73830_3_, int p_73830_4_)
    {
        ...
        // Alkazia
        if(mc.server != null && (mc.server == serverType.TRAINING || mc.server == serverType.OTHER) && mc.renderHUD)  {
        	showHUD(var8);
        }
        ...
        if (this.mc.gameSettings.showDebugInfo)
        {
            ...
            GL11.glPushMatrix();
            var8.drawStringWithShadow(EnumChatFormatting.RED + "MC 1.7.10 (" + this.mc.debug + ")", 2, 2, 16777215);
            ...
            String var20 = EnumChatFormatting.RED + "Used memory: " + var45 * 100L / var36 + "% (" + var45 / 1024L / 1024L + "MB) of " + var36 / 1024L / 1024L + "MB";
            var21 = 14737632;
            ...
            this.drawString(var8, String.format(EnumChatFormatting.RED + "x:" + EnumChatFormatting.GRAY + " %.5f (%d)", new Object[] {Double.valueOf(this.mc.thePlayer.posX), Integer.valueOf(var22), Integer.valueOf(var22 >> 4), Integer.valueOf(var22 & 15)}), 2, 12, 14737632);
            this.drawString(var8, String.format(EnumChatFormatting.RED + "y: " + EnumChatFormatting.GRAY + "%.3f (feet pos, %.3f eyes pos)", new Object[] {Double.valueOf(this.mc.thePlayer.boundingBox.minY), Double.valueOf(this.mc.thePlayer.posY)}), 2, 22, 14737632);
            this.drawString(var8, String.format(EnumChatFormatting.RED + "z: " + EnumChatFormatting.GRAY + "%.5f (%d)", new Object[] {Double.valueOf(this.mc.thePlayer.posZ), Integer.valueOf(var24), Integer.valueOf(var24 >> 4), Integer.valueOf(var24 & 15)}), 2, 32, 14737632);
            int var25 = MathHelper.floor_double((double)(this.mc.thePlayer.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3;
            this.drawString(var8, EnumChatFormatting.RED +  "Direction: " + EnumChatFormatting.GRAY + Direction.directions[var25], 2, 42, 14737632);
            ...
            if (this.mc.theWorld != null && this.mc.theWorld.blockExists(var22, var23, var24))
            {
                ...
                this.drawString(var8, EnumChatFormatting.RED +  "Biome: " + EnumChatFormatting.GRAY + var26.getBiomeGenForWorldCoords(var22 & 15, var24 & 15, this.mc.theWorld.getWorldChunkManager()).biomeName +EnumChatFormatting.RED +  " Luminosité: " + EnumChatFormatting.GRAY + var26.getBlockLightValue(var22 & 15, var23, var24 & 15, 0), 2, 52, 14737632);
            }
            ...
            {
                this.drawString(var8, String.format(EnumChatFormatting.RED + "Shader Minecraft : " + EnumChatFormatting.GRAY + "%s", new Object[] {this.mc.entityRenderer.getShaderGroup().getShaderGroupName()}), 2, 62, 14737632);
            }
...
private void showHUD(FontRenderer var8) {
		...
		!this.mc.gameSettings.showDebugInfo) {
			...
			if (casque != null) {
				...
				itemRenderer.renderItemIntoGUI(var8,
						this.mc.getTextureManager(), casque, 2, 2 + 18 * j);
				GL11.glDisable(GL11.GL_LIGHTING);
				++j;
			}
			...
			if (plastron != null) {
				...
				itemRenderer.renderItemIntoGUI(var8,
						this.mc.getTextureManager(), plastron, 2, 2 + 18 * j);
				GL11.glDisable(GL11.GL_LIGHTING);
				++j;
			}
			...
			if (pantalon != null) {
				...
				var8.drawString(thePotion, 20, 7 + 18 * j, 16777215);
				itemRenderer.renderItemIntoGUI(var8,
						this.mc.getTextureManager(), pantalon, 2, 2 + 18 * j);
				GL11.glDisable(GL11.GL_LIGHTING);
				++j;
			}
			...
			if (bottes != null) {
				...
				var8.drawString(thePotion, 20, 7 + 18 * j, 16777215);
				itemRenderer.renderItemIntoGUI(var8,
						this.mc.getTextureManager(), bottes, 2, 2 + 18 * j);
				GL11.glDisable(GL11.GL_LIGHTING);
				++j;
			}
			...
			if (main != null && (main.getItem() instanceof ItemSword
							...
							|| main.getItem() instanceof ItemBowGranite
							|| main.getItem() instanceof ItemBowBauxite
							|| main.getItem() instanceof ItemBowMeteor
							|| main.getItem() instanceof ItemBowOpale
				...
				var8.drawString(thePotion, 20, 7 + 18 * j, 16777215);
				itemRenderer.renderItemIntoGUI(var8,
						this.mc.getTextureManager(), main, 2, 2 + 18 * j);
				GL11.glDisable(GL11.GL_LIGHTING);
				++j;
			}
