...
public class RenderBiped extends RenderLiving
{
    ...
    private static final String[] bipedArmorFilenamePrefix = new String[] {"leather", "chainmail", "iron", "diamond", "gold", "bauxite", "granite", "opale", "meteor", "ninja"}; /** Alkazia */
