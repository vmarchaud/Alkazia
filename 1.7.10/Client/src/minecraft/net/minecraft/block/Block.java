...
public class Block
{
    ...
    public static void registerBlocks()
    {
        ...
        // Alkazia - V4 
        blockRegistry.addObject(224, "presentBlock", (new BlockPresent()).setHardness(10.0F).setResistance(5.0F).setStepSound(soundTypeCloth).setBlockName("presentBlock").setBlockTextureName("present"));
