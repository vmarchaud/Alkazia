...
public class SpigotConfig
{
    ...
    /** -->Alkazia */
    public static String outdatedClientMessage = "Retéléchargez le launcher!";
    public static String outdatedServerMessage = "Retéléchargez le launcher!";
