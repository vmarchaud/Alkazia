...
public class HandshakeListener implements PacketHandshakingInListener {
    ...
    public void a(PacketHandshakingInSetProtocol packethandshakinginsetprotocol) {
        ...
        case 1:
            ...
            // CraftBukkit end
            /** Alkazia */ // Alkazia - so much login anticheat
            if (packethandshakinginsetprotocol.d() > 42 || packethandshakinginsetprotocol.yolo == null) {
                chatcomponenttext = new ChatComponentText("Launcher obligatoire pour jouer : alkazia.fr"); // Spigot 
                this.b.handle(new PacketLoginOutDisconnect(chatcomponenttext), new GenericFutureListener[0]);
                this.b.a((IChatBaseComponent) chatcomponenttext);
            } else if (packethandshakinginsetprotocol.d() < 42 || packethandshakinginsetprotocol.yolo == null) {
                chatcomponenttext = new ChatComponentText("Launcher obligatoire pour jouer : alkazia.fr"); // Spigot
                this.b.handle(new PacketLoginOutDisconnect(chatcomponenttext), new GenericFutureListener[0]);
                this.b.a((IChatBaseComponent) chatcomponenttext);
            } else {
