...
public class TileEntityIronChest extends TileEntity implements IInventory {
    ...
    private ItemStack[] items = new ItemStack[54]; // CraftBukkit - 36 -> 27
    public boolean a;
    public TileEntityIronChest i;
    public TileEntityIronChest j;
    public TileEntityIronChest k;
    public TileEntityIronChest l;
    public float m;
    public float n;
    public int o;
    private int ticks;
    ...
    private void a(TileEntityIronChest tileentitychest, int i) {
    ...
    public void i() {
        if (!this.a) {
            ...
            if (this.a(this.x - 1, this.y, this.z)) {
                this.k = (TileEntityIronChest) this.world.getTileEntity(this.x - 1, this.y, this.z);
            }

            if (this.a(this.x + 1, this.y, this.z)) {
                this.j = (TileEntityIronChest) this.world.getTileEntity(this.x + 1, this.y, this.z);
            }

            if (this.a(this.x, this.y, this.z - 1)) {
                this.i = (TileEntityIronChest) this.world.getTileEntity(this.x, this.y, this.z - 1);
            }

            if (this.a(this.x, this.y, this.z + 1)) {
                this.l = (TileEntityIronChest) this.world.getTileEntity(this.x, this.y, this.z + 1);
            }
    ...
    private boolean a(int i, int j, int k) {
        ...
        return block instanceof BlockIronChest && ((BlockIronChest) block).a == this.j();
    }
    ...
    public void l_() {
        if (this.q() instanceof BlockIronChest) {
            int oldPower = Math.max(0, Math.min(15, this.o)); // CraftBukkit - Get power before new viewer is added
    ...
    public int j() {
        if (this.r == -1) {
            if (this.world == null || !(this.q() instanceof BlockIronChest)) {
                return 0;
            }

            this.r = ((BlockIronChest) this.q()).a;
        }
