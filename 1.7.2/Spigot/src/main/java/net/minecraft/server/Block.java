...
public class Block {
    ...
    public static void p() {
        ...
        REGISTRY.a(7, "bedSTONE", (new Block(Material.STONE)).s().b(6000000.0F).a(i).c("bedSTONE").H().a(CreativeModeTab.b).d("bedSTONE"));
        ...
        REGISTRY.a(49, "obsidian", (new BlockObsidian()).c(50.0F).b(23.0F).a(i).c("obsidian").d("obsidian")); /** Alkazia */
        ...
        REGISTRY.a(87, "netherrack", (new BlockBloodStone()).c(0.4F).a(i).c("hellSTONE").d("netherrack"));
        ...
        REGISTRY.a(116, "enchanting_table", (new BlockEnchantmentTable()).c(5.0F).b(23.0F).c("enchantmentTable").d("enchanting_table")); /** Alkazia */
        ...
        REGISTRY.a(130, "ender_chest", (new BlockEnderChest()).c(22.5F).b(25.0F).a(i).c("enderChest").a(0.5F)); /** Alkazia */
        ...
        REGISTRY.a(145, "anvil", (new BlockAnvil()).c(5.0F).a(p).b(23.0F).c("anvil")); /** Alkazia */
        ...
        REGISTRY.a(200, "bauxite_ore", (new BlockOre()).c(3.0F).b(5.0F).a(i).c("oreBauxite").H().d("bauxite_ore"));
        REGISTRY.a(201, "granite_ore", (new BlockOre()).c(3.0F).b(5.0F).a(i).c("oreGranite").H().d("granite_ore"));
        REGISTRY.a(202, "opale_ore", (new BlockOre()).c(3.0F).b(5.0F).a(i).c("oreOpale").H().d("opale_ore"));
        REGISTRY.a(203, "meteor_ore", (new BlockOre()).c(3.0F).b(5.0F).a(i).c("oreMeteor").H().d("meteor_ore"));
        
        REGISTRY.a(204, "bauxite_block", (new BlockOreBlock(MaterialMapColor.G)).c(5.0F).b(10.0F).a(j).c("blockBauxite").H().d("bauxite_block"));
        REGISTRY.a(205, "granite_block", (new BlockOreBlock(MaterialMapColor.G)).c(5.0F).b(10.0F).a(j).c("blockGranite").H().d("granite_block"));
        REGISTRY.a(206, "opale_block", (new BlockOreBlock(MaterialMapColor.G)).c(5.0F).b(10.0F).a(j).c("blockOpale").H().d("opale_block"));
        REGISTRY.a(207, "meteor_block", (new BlockOreBlock(MaterialMapColor.G)).c(5.0F).b(10.0F).a(j).c("blockMeteor").H().d("meteor_block"));
        
        REGISTRY.a(208, "pousse", (new Block(Material.HEAVY)).c(5.0F).b(10.0F).a(i).c("pousse").a(CreativeModeTab.b).d("pousse"));
        REGISTRY.a(209, "iron_chest", (new BlockIronChest(0)).c(2.5F).a(f).c("iron_chest"));
        REGISTRY.a(210, "meteorite", (new BlockMeteorite()).c(50.0F).b(23.0F).a(i).c("meteorite").d("meteorite"));
        REGISTRY.a(211, "invisible", (new BlockInvisible(Material.SHATTERABLE, false)).c(0.3F).a(k).c("invisible").d("invisible").a(1.0F));
        //REGISTRY.a(212, "invisible_door", (new BlockDoor(Material.ORE)).c(5.0F).a(j).c("doorInvisible").H().d("invisible_door"));
        REGISTRY.a(213, "lumiere", (new BlockAir()).c("lumiere").c(10.0F).a(CreativeModeTab.b).a(1.0F));
        
        // Alkazia - Define new block -V2-
        REGISTRY.a(214, "andesite", (new Block(Material.STONE)).c(5.0F).a(j).b(5.0F).c("andesite").a(CreativeModeTab.b).d("andesite")); 
        REGISTRY.a(215, "andesite_smooth", (new Block(Material.STONE)).c(5.0F).a(j).b(5.0F).c("andesite_smooth").a(CreativeModeTab.b).d("andesite_smooth")); 
        REGISTRY.a(216, "alumite", (new Block(Material.STONE)).c(5.0F).a(j).b(5.0F).c("alumite").a(CreativeModeTab.b).d("alumite")); 
        REGISTRY.a(217, "alumite_smooth", (new Block(Material.STONE)).c(5.0F).a(j).b(5.0F).c("alumite_smooth").a(CreativeModeTab.b).d("alumite_smooth")); 
        REGISTRY.a(218, "diorite", (new Block(Material.STONE)).c(5.0F).a(j).b(5.0F).c("diorite").a(CreativeModeTab.b).d("diorite")); 
        REGISTRY.a(219, "diorite_smooth", (new Block(Material.STONE)).c(5.0F).a(j).b(5.0F).c("diorite_smooth").a(CreativeModeTab.b).d("diorite_smooth")); 
        REGISTRY.a(220, "ironLadder", (new BlockLadder()).c(0.4F).a(o).c("iron_ladder").d("iron_ladder"));
        REGISTRY.a(221, "powderBlock", (new BlockPowder()).c(5.0F).a(j).c("powderBlock").d("powder"));
    ...
    public void a(World world, EntityHuman entityhuman, int i, int j, int k, int l) {
        ...
        // Alkazia - meteor dont lootable
        if ((this.E() && EnchantmentManager.hasSilkTouchEnchantment(entityhuman)) && this != Blocks.METEORITE) {
