...
public class BiomeDecorator {
   ...
   /* protected WorldGenMinable alumiteGen;
    ...
    public BiomeDecorator() {
        ...
        /*this.alumiteGen = new WorldGenMinable(Blocks.alumite, 20);
        this.andesiteGen = new WorldGenMinable(Blocks.andesite, 20);
        this.dioriteGen = new WorldGenMinable(Blocks.diorite, 20);*/
    ...
    protected void a() {
        ...
        this.a(10, this.alumiteGen, 40, 256);
        this.a(10, this.andesiteGen, 40, 256);
        this.a(10, this.dioriteGen, 40, 256);
