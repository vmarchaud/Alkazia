    ...
    public void a(PacketPlayInFlying packetplayinflying) {
        ...
        if (!this.player.viewingCredits) {
            ...
            if (this.checkMovement && !this.player.dead) {
                ...
                if (d10 > 0.0625D && !this.player.isSleeping() && !this.player.playerInteractManager.isCreative() && !this.player.hasEffect(MobEffectList.FASTER_MOVEMENT) && !this.player.hasEffect(MobEffectList.JUMP)) {
                    flag1 = true;
