...
public class RecipesWeapons {
    ...
    public RecipesWeapons() {
        ...
        this.b = new Object[][] { { Blocks.WOOD, Blocks.COBBLESTONE, Items.IRON_INGOT, Items.DIAMOND, Items.GOLD_INGOT, Items.BAUXITE_INGOT, Items.GRANITE, Items.OPALE, Items.METEOR_FRAGMENT}, 
        		{ Items.WOOD_SWORD, Items.STONE_SWORD, Items.IRON_SWORD, Items.DIAMOND_SWORD, Items.GOLD_SWORD, Items.BAUXITE_SWORD, Items.GRANITE_SWORD, Items.OPALE_SWORD, Items.METEOR_SWORD}};
    }
