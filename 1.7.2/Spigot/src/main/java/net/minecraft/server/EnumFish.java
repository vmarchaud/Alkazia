...
public enum EnumFish {
    ...
    // Alkazia - wow so much fish
    NINJAFISH("NINJAFISH", 4, 4, "ninjafish", 2, 0.1F, 6, 1.0F);
    ...
    private static final EnumFish[] o = new EnumFish[] { COD, SALMON, CLOWNFISH, PUFFERFISH, NINJAFISH};
