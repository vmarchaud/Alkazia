...
public class Block
{
    ...
    public static void registerBlocks()
    {
        ...
        blockRegistry.addObject(49, "obsidian", (new BlockObsidian()).setHardness(50.0F).setResistance(25.0F).setStepSound(soundTypePiston).setBlockName("obsidian").setBlockTextureName("obsidian")); /** Alkazia */
        ...
        blockRegistry.addObject(116, "enchanting_table", (new BlockEnchantmentTable()).setHardness(5.0F).setResistance(23.0F).setBlockName("enchantmentTable").setBlockTextureName("enchanting_table")); /** Alkazia */
        ...
        blockRegistry.addObject(130, "ender_chest", (new BlockEnderChest()).setHardness(22.5F).setResistance(25.0F).setStepSound(soundTypePiston).setBlockName("enderChest").setLightLevel(0.5F)); /** Alkazia */
        ...
        blockRegistry.addObject(145, "anvil", (new BlockAnvil()).setHardness(5.0F).setStepSound(soundTypeAnvil).setResistance(23.0F).setBlockName("anvil")); /** Alkazia */
        ...
        blockRegistry.addObject(200, "bauxite_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).disableStats().setBlockName("oreBauxite").setBlockTextureName("bauxite_ore"));
        blockRegistry.addObject(201, "granite_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).disableStats().setBlockName("oreGranite").setBlockTextureName("granite_ore"));
        blockRegistry.addObject(202, "opale_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).disableStats().setBlockName("oreOpale").setBlockTextureName("opale_ore"));
        blockRegistry.addObject(203, "meteor_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).disableStats().setBlockName("oreMeteor").setBlockTextureName("meteor_ore"));
       
        blockRegistry.addObject(204, "bauxite_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).disableStats().setStepSound(soundTypeMetal).setBlockName("blockBauxite").setBlockTextureName("bauxite_block"));
        blockRegistry.addObject(205, "granite_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).disableStats().setStepSound(soundTypeMetal).setBlockName("blockGarnite").setBlockTextureName("granite_block"));
        blockRegistry.addObject(206, "opale_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).disableStats().setStepSound(soundTypeMetal).setBlockName("blockOpale").setBlockTextureName("opale_block"));
        blockRegistry.addObject(207, "meteor_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).disableStats().setStepSound(soundTypeMetal).setBlockName("blockMeteor").setBlockTextureName("meteor_block"));
        
        blockRegistry.addObject(208, "pousse", (new Block(Material.anvil)).setHardness(5.0F).setStepSound(soundTypePiston).setResistance(10.0F).setBlockName("pousse").setCreativeTab(CreativeTabs.tabBlock).setBlockTextureName("pousse")); 
        blockRegistry.addObject(209, "iron_chest", (new BlockIronChest(0)).setHardness(2.5F).setStepSound(soundTypeWood).setBlockName("chestIron").setCreativeTab(CreativeTabs.tabDecorations)); //modif
        blockRegistry.addObject(210, "meteorite", (new BlockMeteorite()).setHardness(50.0F).setResistance(23.0F).setStepSound(soundTypePiston).setBlockName("meteor_brut").setBlockTextureName("meteor_brut")); //modif
        blockRegistry.addObject(211, "invisible", (new BlockInvisible()).setHardness(10.0F).setStepSound(soundTypeGlass).setLightLevel(1.0F).setBlockName("invisible").setBlockTextureName("invisible")); //modif
        //blockRegistry.addObject(212, "invisible_door", (new BlockDoor(Material.rock)).setHardness(5.0F).setStepSound(soundTypeMetal).setBlockName("doorInvisible").disableStats().setBlockTextureName("door_invisible").setCreativeTab(CreativeTabs.tabRedstone)); //modif
        blockRegistry.addObject(213, "lumiere", (new BlockAir()).setHardness(10.0F).setStepSound(soundTypeGlass).setLightLevel(1.0F).setBlockName("lumiere").setBlockTextureName("lumiere").setCreativeTab(CreativeTabs.tabBlock)); //modif
        
        // Alkazia - Define new block -V2-
        blockRegistry.addObject(214, "andesite", (new Block(Material.rock)).setHardness(5.0F).setStepSound(soundTypePiston).setResistance(5.0F).setBlockName("andesite").setCreativeTab(CreativeTabs.tabBlock).setBlockTextureName("andesite")); 
        blockRegistry.addObject(215, "andesite_smooth", (new Block(Material.rock)).setHardness(5.0F).setStepSound(soundTypePiston).setResistance(5.0F).setBlockName("andesite_smooth").setCreativeTab(CreativeTabs.tabBlock).setBlockTextureName("andesite_smooth")); 
        blockRegistry.addObject(216, "alumite", (new Block(Material.rock)).setHardness(5.0F).setStepSound(soundTypePiston).setResistance(5.0F).setBlockName("alumite").setCreativeTab(CreativeTabs.tabBlock).setBlockTextureName("alumite")); 
        blockRegistry.addObject(217, "alumite_smooth", (new Block(Material.rock)).setHardness(5.0F).setStepSound(soundTypePiston).setResistance(5.0F).setBlockName("alumite_smooth").setCreativeTab(CreativeTabs.tabBlock).setBlockTextureName("alumite_smooth")); 
        blockRegistry.addObject(218, "diorite", (new Block(Material.rock)).setHardness(5.0F).setStepSound(soundTypePiston).setResistance(5.0F).setBlockName("diorite").setCreativeTab(CreativeTabs.tabBlock).setBlockTextureName("diorite")); 
        blockRegistry.addObject(219, "diorite_smooth", (new Block(Material.rock)).setHardness(5.0F).setStepSound(soundTypePiston).setResistance(5.0F).setBlockName("diorite_smooth").setCreativeTab(CreativeTabs.tabBlock).setBlockTextureName("diorite_smooth")); 
        blockRegistry.addObject(220, "ironLadder", (new BlockLadder()).setHardness(0.4F).setStepSound(soundTypeLadder).setBlockName("iron_ladder").setBlockTextureName("iron_ladder"));
        blockRegistry.addObject(221, "powderBlock", (new BlockPowder()).setHardness(20.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("powderBlock").setBlockTextureName("powder"));
        
        // Alkazia - V3 bitch
        blockRegistry.addObject(222, "fakub", (new Block(Material.rock)).setHardness(50.0F).setResistance(2000.0F).setStepSound(soundTypePiston).setBlockName("fakub").setBlockTextureName("fakub").setCreativeTab(CreativeTabs.tabBlock));
        blockRegistry.addObject(223, "fakub_off", (new Block(Material.rock)).setHardness(50.0F).setResistance(2000.0F).setStepSound(soundTypePiston).setBlockName("fakub_off").setBlockTextureName("fakub_off").setCreativeTab(CreativeTabs.tabBlock));
    ...
    public void harvestBlock(World p_149636_1_, EntityPlayer p_149636_2_, int p_149636_3_, int p_149636_4_, int p_149636_5_, int p_149636_6_)
    {
        ...
        // Alkazia - no drop for meteorite
        if (this.canSilkHarvest() && EnchantmentHelper.getSilkTouchModifier(p_149636_2_) && this != Blocks.meteorite && this != Blocks.powderBlock && this != Blocks.meteor_ore)
        {
