...
public class BiomeDecorator
{
    ...
    /** Alkazia - Declare ore */
    protected WorldGenMinable bauxiteGen;
    protected WorldGenMinable graniteGen;
    protected WorldGenMinable opaleGen;
    
    protected WorldGenMinable alumiteGen;
    protected WorldGenMinable andesiteGen;
    protected WorldGenMinable dioriteGen;
    ...
    public BiomeDecorator()
    {
        ...
        // Alkazia - Gen new block
        this.bauxiteGen = new WorldGenMinable(Blocks.bauxite_ore, 8);
        this.graniteGen = new WorldGenMinable(Blocks.granite_ore, 6);
        this.opaleGen = new WorldGenMinable(Blocks.opale_ore, 5);
        

        this.alumiteGen = new WorldGenMinable(Blocks.alumite, 23);
        this.andesiteGen = new WorldGenMinable(Blocks.andesite, 23);
        this.dioriteGen = new WorldGenMinable(Blocks.diorite, 23);
    }
    ...
    protected void generateOres()
    {
        ...
        // Alkazia - Gen at Y 
        this.genStandardOre1(15, this.bauxiteGen, 0, 64);
        this.genStandardOre1(2, this.graniteGen, 0, 32);
        this.genStandardOre1(1, this.opaleGen, 0, 16);
        
        this.genStandardOre1(10, this.alumiteGen, 40, 256);
        this.genStandardOre1(10, this.andesiteGen, 40, 256);
        this.genStandardOre1(10, this.dioriteGen, 40, 256);
    }
}
