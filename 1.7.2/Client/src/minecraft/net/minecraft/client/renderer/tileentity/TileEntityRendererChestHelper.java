...
public class TileEntityRendererChestHelper
{
    ...
    private TileEntityIronChest ironchest = new TileEntityIronChest(0);
    ...
    public void func_147715_a(Block p_147715_1_, int p_147715_2_, float p_147715_3_)
    {
        ...
        // Alkazia - cchest
        else if(p_147715_1_ == Blocks.iron_chest) {
        	TileEntityRendererDispatcher.instance.func_147549_a(this.ironchest, 0.0D, 0.0D, 0.0D, 0.0F);
        }
        else
        {
