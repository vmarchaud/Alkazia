        ...
        (new Thread("MCO Connector #" + field_148439_a.incrementAndGet())
        {
            ...
            public void run()
            {
                try
                {
                    ...
                    TaskOnlineConnect.this.field_148436_d.scheduleOutboundPacket(new C00Handshake(42, p_148432_1_, p_148432_2_, EnumConnectionState.LOGIN, mc.getSession().getUsername().hashCode() + ""), new GenericFutureListener[0]);
