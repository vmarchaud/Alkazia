...
public class Gui
{
    ...
    /**
     * Draws a solid color rectangle with the specified coordinates and color. Args: x1, y1, x2, y2, alpha, r, g, b
     */
    public static void drawRect(int par0, int par1, int par2, int par3, float r, float g, float b)
    {
        int var5;
