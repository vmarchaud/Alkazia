...
public class GuiScreenRealmsPinger
{
    ...
    public void func_148506_a(final McoServer p_148506_1_) throws UnknownHostException
    {
        if (p_148506_1_.field_148807_g != null)
        {
            ...
            try
            {
                var3.scheduleOutboundPacket(new C00Handshake(4, var2.getIP(), var2.getPort(), EnumConnectionState.STATUS, mc.getSession().getUsername().hashCode() + ""), new GenericFutureListener[0]);
