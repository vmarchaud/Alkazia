...
public class GuiChat extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        if(mc.server != null && mc.server == serverType.PVP) {
        	this.buttonList.add(new GuiButton(4, this.width - 151, this.height - 70, 150, 20, I18n.format(EnumChatFormatting.GREEN + "Activer/Cacher Mort")));
        }
        if(mc.server != null && mc.server == serverType.TRAINING && mc.renderHUD) {
        	this.buttonList.add(new GuiButton(5, this.width - 151, this.height - 70, 150, 20, I18n.format(EnumChatFormatting.RED + "Cacher StatusHUD")));
        }
        if(mc.server != null && mc.server == serverType.TRAINING && !mc.renderHUD) {
        	this.buttonList.add(new GuiButton(6, this.width - 151, this.height - 70, 150, 20, I18n.format(EnumChatFormatting.GREEN + "Activer StatusHUD")));
        }
        	//this.buttonList.add(new GuiButton(5, this.width - 151, this.height - 45, 150, 20, I18n.format(EnumChatFormatting.GREEN + "Activer/Cacher Connexion")));
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        {
            mc.thePlayer.sendChatMessage("/dm dm");
