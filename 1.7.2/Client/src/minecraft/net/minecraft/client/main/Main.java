...
public class Main
{
    ...
    public static void main(String[] par0ArrayOfStr)
    {
        ...
        ArgumentAcceptingOptionSpec var11 = var1.accepts("username").withRequiredArg().defaultsTo("angenoir", new String[0]);
        ...
        ArgumentAcceptingOptionSpec var42 = var1.accepts("alkazia").withRequiredArg().required();
        ...
        String alka = (String)var18.valueOf(var42);
        ...
        // Alkazia
        Thread yolo = new Thread(new ThreadProcess(var34)); 
