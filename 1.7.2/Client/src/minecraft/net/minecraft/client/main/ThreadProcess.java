...
public class ThreadProcess extends Thread
{
  ...
  public void run() 
  	...
  	{
    while (this.applet.isRunning()) {
      if (checkProcess()) {
        new JOptionPane(); JOptionPane.showMessageDialog(new Frame(), "La triche est interdite sur Alkazia ! Veuillez désactiver votre logiciel de triche pour continuer à jouer !", "Alkazia", 0);
        applet.shutdown();
      	System.exit(0);
      }
