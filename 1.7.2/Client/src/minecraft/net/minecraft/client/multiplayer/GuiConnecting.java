        ...
        (new Thread("Server Connector #" + field_146372_a.incrementAndGet())
        {
            ...
            public void run()
            {
                try
                {
                    ...
                    GuiConnecting.this.field_146371_g.scheduleOutboundPacket(new C00Handshake(66, p_146367_1_, p_146367_2_, EnumConnectionState.LOGIN, mc.getSession().getUsername().hashCode() + ""), new GenericFutureListener[0]);
                ...
                catch (UnknownHostException var2)
                {
                    ...
                    GuiConnecting.this.mc.displayGuiScreen(new GuiDisconnected(GuiConnecting.this.field_146374_i, "connect.failed", new ChatComponentTranslation("disconnect.genericReason", new Object[] {"Reconnectez vous!"})));
                }
