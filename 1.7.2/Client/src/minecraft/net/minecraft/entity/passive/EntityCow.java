...
public class EntityCow extends EntityAnimal
{
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        // Alkazia - add craft of milk potion
        else if (var2 != null && var2.getItem() == Items.glass_bottle && !par1EntityPlayer.capabilities.isCreativeMode)
        {
        	if (var2.stackSize-- == 1)
            {
                par1EntityPlayer.inventory.setInventorySlotContents(par1EntityPlayer.inventory.currentItem, new ItemStack(Items.potionMilk));
            }
            else if (!par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(Items.potionMilk)))
            {
                par1EntityPlayer.dropPlayerItemWithRandomChoice(new ItemStack(Items.potionMilk, 1, 0), false);
            }
            return true;
        }
        else
