...
public abstract class EntityPlayer extends EntityLivingBase implements ICommandSender
{
    ...
    public IIcon getItemIcon(ItemStack par1ItemStack, int par2)
    {
        ...
        else
        {
            ...
            // Alkazia - add render of bows
            
            if (this.itemInUse != null && par1ItemStack.getItem() == Items.bowBauxite)
            {
                int var4 = par1ItemStack.getMaxItemUseDuration() - this.itemInUseCount;

                if (var4 >= 18)
                {
                    return Items.bowBauxite.getItemIconForUseDuration(2);
                }

                if (var4 > 13)
                {
                    return Items.bowBauxite.getItemIconForUseDuration(1);
                }

                if (var4 > 0)
                {
                    return Items.bowBauxite.getItemIconForUseDuration(0);
                }
            }
            
            if (this.itemInUse != null && par1ItemStack.getItem() == Items.bowGranite)
            {
                int var4 = par1ItemStack.getMaxItemUseDuration() - this.itemInUseCount;

                if (var4 >= 18)
                {
                    return Items.bowGranite.getItemIconForUseDuration(2);
                }

                if (var4 > 13)
                {
                    return Items.bowGranite.getItemIconForUseDuration(1);
                }

                if (var4 > 0)
                {
                    return Items.bowGranite.getItemIconForUseDuration(0);
                }
            }
            
            if (this.itemInUse != null && par1ItemStack.getItem() == Items.bowOpale)
            {
                int var4 = par1ItemStack.getMaxItemUseDuration() - this.itemInUseCount;

                if (var4 >= 18)
                {
                    return Items.bowOpale.getItemIconForUseDuration(2);
                }

                if (var4 > 13)
                {
                    return Items.bowOpale.getItemIconForUseDuration(1);
                }

                if (var4 > 0)
                {
                    return Items.bowOpale.getItemIconForUseDuration(0);
                }
            }
            
            if (this.itemInUse != null && par1ItemStack.getItem() == Items.bowMeteor)
            {
                int var4 = par1ItemStack.getMaxItemUseDuration() - this.itemInUseCount;

                if (var4 >= 18)
                {
                    return Items.bowMeteor.getItemIconForUseDuration(2);
                }

                if (var4 > 13)
                {
                    return Items.bowMeteor.getItemIconForUseDuration(1);
                }

                if (var4 > 0)
                {
                    return Items.bowMeteor.getItemIconForUseDuration(0);
                }
            }
        }
    ...
    {
        UUID var1 = Util.tryGetUUIDFromString(p_146094_0_.getId().toString());
