...
public class RecipesArmor
{
    ...
    {
    	/** Alkazia */
        this.recipeItems = new Object[][] {{Items.leather, Blocks.fire, Items.iron_ingot, Items.diamond, Items.gold_ingot, Items.bauxite_ingot, Items.granite, Items.opale, Items.meteor_fragment, Items.ninjaPowder}, 
