...
public class Item
{
    ...
    public static void registerItems()
    {
        ...
        itemRegistry.addObject(500, "glace", (new ItemChocolate(4, 4.0F, false)).setAlwaysEdible().setUnlocalizedName("glace").setTextureName("glace"));
    ...
    {	/** Alkazia */
        ...
        private static final Item.ToolMaterial[] $VALUES = new Item.ToolMaterial[]{WOOD, STONE, IRON, EMERALD, GOLD, BAUXITE, GRANITE, OPALE, METEOR};/** Alkazia */
