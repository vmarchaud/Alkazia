...
public class ItemFishFood extends ItemFood
{
    ...
    protected void onFoodEaten(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        {
            par3EntityPlayer.addPotionEffect(new PotionEffect(Potion.confusion.id, 100, 1));
            par3EntityPlayer.addPotionEffect(new PotionEffect(Potion.confusion.id, 240, 1));
        }
        if (var4 == ItemFishFood.FishType.SALMON) {
        	par3EntityPlayer.addPotionEffect(new PotionEffect(Potion.resistance.id, 240, 0));
        }
    ...
    public static enum FishType
    {
        ...
        NINJAFISH("NINJAFISH", 4, 4, "ninjafish", 2, 0.1F, 6, 0.8F);
        ...
        private static final ItemFishFood.FishType[] $VALUES = new ItemFishFood.FishType[]{COD, SALMON, CLOWNFISH, PUFFERFISH, NINJAFISH};
