...
public class ItemArmor extends Item
{
    ...
    {	/** Alkazia */
        ...
        BAUXITE("BAUXITE", 5, 27, new int[]{3, 7, 5, 3}, 9),
        
        GRANITE("GRANITE", 6, 40, new int[]{4, 7, 5, 4}, 10),
        OPALE("OPALE", 7, 45, new int[]{5, 7, 6, 5}, 10),
        METEOR("METEOR", 8, 50, new int[]{5, 8, 6, 5}, 10),
        ...
        private static final ItemArmor.ArmorMaterial[] $VALUES = new ItemArmor.ArmorMaterial[]{CLOTH, CHAIN, IRON, GOLD, DIAMOND, BAUXITE, GRANITE, OPALE, METEOR, NINJA}; /** Alkazia */
        ...
        {
            return ItemArmor.maxDamageArray[par1] * this.maxDamageFactor + 150;
        }
