...
public class ContainerEnchantment extends Container
{
    ...
    public boolean enchantItem(EntityPlayer playerIn, int id)
    {
        ...
        int var5 = id;
        // Alkazia - level cost for enchant 
        if(playerIn.func_175138_ci() >= 28) var5 = var5 + 10;
        else if(playerIn.func_175138_ci() >= 25) var5 = var5 + 9;
        else if(playerIn.func_175138_ci() >= 22) var5 = var5 + 8;
        else if(playerIn.func_175138_ci() >= 20) var5 = var5 + 7;
        else if(playerIn.func_175138_ci() >= 17) var5 = var5 + 6;
        else if(playerIn.func_175138_ci() >= 14) var5 = var5 + 5;
        else if(playerIn.func_175138_ci() >= 12) var5 = var5 + 4;
        else if(playerIn.func_175138_ci() >= 10) var5 = var5 + 3;
        else if(playerIn.func_175138_ci() >= 7) var5 = var5 + 2;
        else if(playerIn.func_175138_ci() >= 4) var5 = var5 + 1;
