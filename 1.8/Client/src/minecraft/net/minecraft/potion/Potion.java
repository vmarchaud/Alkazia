...
public class Potion
{
    ...
    // Alkazia - new potion effect
    public static final Potion fall = (new Potion(24 , new ResourceLocation("fall"), false, 3426654)).setPotionName("potion.fall").setIconIndex(3, 2);
    ...
    public void performEffect(EntityLivingBase p_76394_1_, int p_76394_2_)
    {
        ...
        else if ((this.id != heal.id || p_76394_1_.isEntityUndead()) && (this.id != harm.id || !p_76394_1_.isEntityUndead()))
        {
            ...
            {
                p_76394_1_.attackEntityFrom(DamageSource.magic, (float)(3 << p_76394_2_)); // Alkazia - fix op damage potion
            }
        }
        else
        {
    ...
    public void func_180793_a(Entity p_180793_1_, Entity p_180793_2_, EntityLivingBase p_180793_3_, int p_180793_4_, double p_180793_5_)
    {
        ...
        if ((this.id != heal.id || p_180793_3_.isEntityUndead()) && (this.id != harm.id || !p_180793_3_.isEntityUndead()))
        {
            ...
            {
                var7 = (int)(p_180793_5_ * (double)(3 << p_180793_4_) + 0.5D); // Alkazia - Fix op damage potion
