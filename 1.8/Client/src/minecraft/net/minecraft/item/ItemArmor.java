...
public class ItemArmor extends Item
{
    ...
    public static enum ArmorMaterial
    {
        ...
        DIAMOND("DIAMOND", 4, "diamond", 33, new int[]{3, 7, 4, 3}, 10),
        // Alkazia - register new armors
        BAUXITE("BAUXITE", 5, "bauxite", 27, new int[]{3, 7, 5, 3}, 9),
        GRANITE("GRANITE", 6, "granite", 40, new int[]{4, 7, 5, 4}, 10),
        OPALE("OPALE", 7,	"opale", 45, new int[]{5, 7, 6, 5}, 10),
        METEOR("METEOR", 8,"meteor", 50, new int[]{5, 8, 6, 5}, 10),
        NINJA("NINJA", 9, "ninja", 18, new int[]{2, 5, 3, 2}, 9);
        ...
        private static final ItemArmor.ArmorMaterial[] $VALUES = new ItemArmor.ArmorMaterial[]{LEATHER, CHAIN, IRON, GOLD, DIAMOND, BAUXITE, GRANITE, OPALE, METEOR, NINJA};
