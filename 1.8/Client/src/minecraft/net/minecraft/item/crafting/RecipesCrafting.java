...
public class RecipesCrafting
{
    ...
    public void addRecipes(CraftingManager p_77589_1_)
    {
        ...
        p_77589_1_.addRecipe(new ItemStack(Blocks.pousse), new Object[] {"# #", " # ", "# #", '#', Blocks.cobblestone});
        p_77589_1_.addRecipe(new ItemStack(Items.name_tag), new Object[] {"*##", '#', Items.paper, '*', Items.string});
        p_77589_1_.addRecipe(new ItemStack(Blocks.iron_chest), new Object[] {"###", "#X#", "###", '#', Items.iron_ingot, 'X', Blocks.chest});
        
        p_77589_1_.addRecipe(new ItemStack(Items.potionFall), new Object[] {"#O#",'#', Items.feather, 'O', Items.potionitem});
        p_77589_1_.addRecipe(new ItemStack(Blocks.iron_ladder, 4), new Object[] {"# #", "###", "# #",'#', Items.iron_ingot});
    }
}
