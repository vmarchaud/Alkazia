...
public class RecipesTools
{
    ...
    public RecipesTools()
    {
        ...
        this.recipeItems = new Object[][] {{Blocks.planks, Blocks.cobblestone, Items.iron_ingot, Items.diamond, Items.gold_ingot, Items.bauxite_ingot, Items.graniteItem, Items.opale, Items.meteor_ingot},
        		...
        		{Items.wooden_shovel, Items.stone_shovel, Items.iron_shovel, Items.diamond_shovel, Items.golden_shovel, Items.bauxite_shovel, Items.granite_shovel, Items.opale_shovel, Items.meteor_shovel}, 
