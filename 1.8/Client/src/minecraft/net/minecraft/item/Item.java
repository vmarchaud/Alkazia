...
import net.minecraft.block.BlockIronChest;
...
public class Item
{
    ...
    public static void registerItems()
    {
        ...
        // Alkazia - register item block
        registerItemBlock(Blocks.bauxite_ore);
        registerItemBlock(Blocks.granite_ore);
        registerItemBlock(Blocks.opale_ore);
        registerItemBlock(Blocks.meteor_ore);
       
        registerItemBlock(Blocks.bauxite_block);
        registerItemBlock(Blocks.granite_block);
        registerItemBlock(Blocks.opale_block);
        registerItemBlock(Blocks.meteor_block);
       
        registerItemBlock(Blocks.pousse);
        registerItemBlock(Blocks.iron_chest);
        registerItemBlock(Blocks.meteorite);
        registerItemBlock(Blocks.invisible);
        registerItemBlock(Blocks.lumiere);
        registerItemBlock(Blocks.iron_ladder);
        registerItemBlock(Blocks.powderBlock);
        ...
        // Alkazia - Register new item
           registerItem(450, "bauxite_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.BAUXITE, 5, 0)).setUnlocalizedName("bauxite_helmet"));
           registerItem(451, "bauxite_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.BAUXITE, 5, 1)).setUnlocalizedName("bauxite_chestplate"));
           registerItem(452, "bauxite_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.BAUXITE, 5, 2)).setUnlocalizedName("bauxite_leggings"));
           registerItem(453, "bauxite_boots", (new ItemArmor(ItemArmor.ArmorMaterial.BAUXITE, 5, 3)).setUnlocalizedName("bauxite_boots"));
           
           registerItem(454, "granite_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.GRANITE, 6, 0)).setUnlocalizedName("granite_helmet"));
           registerItem(455, "granite_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.GRANITE, 6, 1)).setUnlocalizedName("granite_chestplate"));
           registerItem(456, "granite_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.GRANITE, 6, 2)).setUnlocalizedName("granite_leggings"));
           registerItem(457, "granite_boots", (new ItemArmor(ItemArmor.ArmorMaterial.GRANITE, 6, 3)).setUnlocalizedName("granite_boots"));
           
           registerItem(458, "opale_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.OPALE, 7, 0)).setUnlocalizedName("opale_helmet"));
           registerItem(459, "opale_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.OPALE, 7, 1)).setUnlocalizedName("opale_chestplate"));
           registerItem(460, "opale_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.OPALE, 7, 2)).setUnlocalizedName("opale_leggings"));
           registerItem(461, "opale_boots", (new ItemArmor(ItemArmor.ArmorMaterial.OPALE, 7, 3)).setUnlocalizedName("opale_boots"));
           
           registerItem(462, "meteor_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.METEOR, 8, 0)).setUnlocalizedName("meteor_helmet"));
           registerItem(463, "meteor_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.METEOR, 8, 1)).setUnlocalizedName("meteor_chestplate"));
           registerItem(464, "meteor_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.METEOR, 8, 2)).setUnlocalizedName("meteor_leggings"));
           registerItem(465, "meteor_boots", (new ItemArmor(ItemArmor.ArmorMaterial.METEOR, 8, 3)).setUnlocalizedName("meteor_boots"));
           
           registerItem(466, "ninja_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.NINJA, 9, 0)).setUnlocalizedName("ninja_helmet"));
           registerItem(467, "ninja_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.NINJA, 9, 1)).setUnlocalizedName("ninja_chestplate"));
           registerItem(468, "ninja_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.NINJA, 9, 2)).setUnlocalizedName("ninja_leggings"));
           registerItem(469, "ninja_boots", (new ItemArmor(ItemArmor.ArmorMaterial.NINJA, 9, 3)).setUnlocalizedName("ninja_boots"));
           
           registerItem(470, "bauxite_sword", (new ItemSword(Item.ToolMaterial.BAUXITE)).setUnlocalizedName("bauxite_sword"));
           registerItem(471, "bauxite_shovel", (new ItemSpade(Item.ToolMaterial.BAUXITE)).setUnlocalizedName("bauxite_shovel"));
           registerItem(472, "bauxite_pickaxe", (new ItemPickaxe(Item.ToolMaterial.BAUXITE)).setUnlocalizedName("bauxite_pickaxe"));
           registerItem(473, "bauxite_axe", (new ItemAxe(Item.ToolMaterial.BAUXITE)).setUnlocalizedName("bauxite_axe"));
           registerItem(474, "bauxite_hoe", (new ItemHoe(Item.ToolMaterial.BAUXITE)).setUnlocalizedName("bauxite_hoe"));
           
           registerItem(475, "granite_sword", (new ItemSword(Item.ToolMaterial.GRANITE)).setUnlocalizedName("granite_sword"));
           registerItem(476, "granite_shovel", (new ItemSpade(Item.ToolMaterial.GRANITE)).setUnlocalizedName("granite_shovel"));
           registerItem(477, "granite_pickaxe", (new ItemPickaxe(Item.ToolMaterial.GRANITE)).setUnlocalizedName("granite_pickaxe"));
           registerItem(478, "granite_axe", (new ItemAxe(Item.ToolMaterial.GRANITE)).setUnlocalizedName("granite_axe"));
           registerItem(479, "granite_hoe", (new ItemHoe(Item.ToolMaterial.GRANITE)).setUnlocalizedName("granite_hoe"));
           
           registerItem(480, "opale_sword", (new ItemSword(Item.ToolMaterial.OPALE)).setUnlocalizedName("opale_sword"));
           registerItem(481, "opale_shovel", (new ItemSpade(Item.ToolMaterial.OPALE)).setUnlocalizedName("opale_shovel"));
           registerItem(482, "opale_pickaxe", (new ItemPickaxe(Item.ToolMaterial.OPALE)).setUnlocalizedName("opale_pickaxe"));
           registerItem(483, "opale_axe", (new ItemAxe(Item.ToolMaterial.OPALE)).setUnlocalizedName("opale_axe"));
           registerItem(484, "opale_hoe", (new ItemHoe(Item.ToolMaterial.OPALE)).setUnlocalizedName("opale_hoe"));
           
           registerItem(485, "meteor_sword", (new ItemSword(Item.ToolMaterial.METEOR)).setUnlocalizedName("meteor_sword"));
           registerItem(486, "meteor_shovel", (new ItemSpade(Item.ToolMaterial.METEOR)).setUnlocalizedName("meteor_shovel"));
           registerItem(487, "meteor_pickaxe", (new ItemPickaxe(Item.ToolMaterial.METEOR)).setUnlocalizedName("meteor_pickaxe"));
           registerItem(488, "meteor_axe", (new ItemAxe(Item.ToolMaterial.METEOR)).setUnlocalizedName("meteor_axe"));
           registerItem(489, "meteor_hoe", (new ItemHoe(Item.ToolMaterial.METEOR)).setUnlocalizedName("meteor_hoe"));
           
           registerItem(490, "bowBauxite", (new ItemBowBauxite()).setUnlocalizedName("bowBauxite"));
           registerItem(491, "bowGranite", (new ItemBowGranite()).setUnlocalizedName("bowGranite"));
           registerItem(492, "bowOpale", (new ItemBowOpale()).setUnlocalizedName("bowOpale"));
           registerItem(493, "bowMeteor", (new ItemBowMeteor()).setUnlocalizedName("bowMeteor"));
           
           registerItem(495, "bauxite_ingot", (new Item()).setCreativeTab(CreativeTabs.tabMaterials).setUnlocalizedName("bauxite_ingot"));
           registerItem(496, "graniteItem", (new Item()).setCreativeTab(CreativeTabs.tabMaterials).setUnlocalizedName("graniteItem"));
           registerItem(497, "opale", (new Item()).setCreativeTab(CreativeTabs.tabMaterials).setUnlocalizedName("opale"));
           registerItem(498, "meteor_ingot", (new Item()).setCreativeTab(CreativeTabs.tabMaterials).setUnlocalizedName("meteor_ingot"));
           registerItem(501, "ninjaPowder", (new Item()).setCreativeTab(CreativeTabs.tabMaterials).setUnlocalizedName("ninjaPowder"));
           
           
           registerItem(499, "milkPotion", (new ItemPotionMilk()).setUnlocalizedName("potionMilk"));
           registerItem(504, "potionFall", (new ItemPotionFall()).setUnlocalizedName("potionFall"));
           
           registerItem(506, "potionHaste", (new ItemPotionHaste(0)).setContainerItem(var0).setUnlocalizedName("potionHaste"));
           registerItem(507, "potionHaste2", (new ItemPotionHaste(1)).setContainerItem(var0).setUnlocalizedName("potionHaste"));
           registerItem(508, "potionResistance", (new ItemPotionResistance(0)).setContainerItem(var0).setUnlocalizedName("potionResistance"));
           registerItem(509, "potionResistance2", (new ItemPotionResistance(1)).setContainerItem(var0).setUnlocalizedName("potionResistance"));
    }
    ...
    public static enum ToolMaterial
    {
        ...
        private static final Item.ToolMaterial[] $VALUES = new Item.ToolMaterial[]{WOOD, STONE, IRON, EMERALD, GOLD, BAUXITE, GRANITE, OPALE, METEOR};
            				...
            				(this == EMERALD ? Items.diamond :
            					(this == BAUXITE ? Items.bauxite_ingot :
            						(this == OPALE ? Items.opale :
            							(this == GRANITE ? Items.graniteItem :
            								(this == METEOR ? Items.meteor_ingot :
            					null))))))));
        }
    }
}
