...
public class Block
{
    ...
    public static void registerBlocks()
    {
        ...
        registerBlock(49, "obsidian", (new BlockObsidian()).setHardness(50.0F).setResistance(25.0F).setStepSound(soundTypePiston).setUnlocalizedName("obsidian")); // Alkazia - fix explosion resistance
        ...
        registerBlock(116, "enchanting_table", (new BlockEnchantmentTable()).setHardness(5.0F).setResistance(25.0F).setUnlocalizedName("enchantmentTable"));  // Alkazia - fix explosion resistance
        ...
        registerBlock(130, "ender_chest", (new BlockEnderChest()).setHardness(22.5F).setResistance(25.0F).setStepSound(soundTypePiston).setUnlocalizedName("enderChest").setLightLevel(0.5F));  // Alkazia - fix explosion resistance
        ...
        registerBlock(145, "anvil", (new BlockAnvil()).setHardness(5.0F).setStepSound(soundTypeAnvil).setResistance(25.0F).setUnlocalizedName("anvil"));  // Alkazia - fix explosion resistance
        ...
        // Alkazia - register new block
        registerBlock(200, "bauxite_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).disableStats().setUnlocalizedName("bauxite_ore"));
        registerBlock(201, "granite_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).disableStats().setUnlocalizedName("granite_ore"));
        registerBlock(202, "opale_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).disableStats().setUnlocalizedName("opale_ore"));
        registerBlock(203, "meteor_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).disableStats().setUnlocalizedName("meteor_ore"));
       
        registerBlock(204, "bauxite_block", (new BlockCompressed(MapColor.redColor)).setHardness(5.0F).setResistance(10.0F).disableStats().setStepSound(soundTypeMetal).setUnlocalizedName("bauxite_block"));
        registerBlock(205, "granite_block", (new BlockCompressed(MapColor.airColor)).setHardness(5.0F).setResistance(10.0F).disableStats().setStepSound(soundTypeMetal).setUnlocalizedName("granite_block"));
        registerBlock(206, "opale_block", (new BlockCompressed(MapColor.blueColor)).setHardness(5.0F).setResistance(10.0F).disableStats().setStepSound(soundTypeMetal).setUnlocalizedName("opale_block"));
        registerBlock(207, "meteor_block", (new BlockCompressed(MapColor.brownColor)).setHardness(5.0F).setResistance(10.0F).disableStats().setStepSound(soundTypeMetal).setUnlocalizedName("meteor_block"));
        
        registerBlock(208, "pousse", (new Block(Material.anvil)).setHardness(5.0F).setStepSound(soundTypePiston).setResistance(10.0F).setCreativeTab(CreativeTabs.tabBlock).setUnlocalizedName("pousse")); 
        registerBlock(209, "iron_chest", (new BlockIronChest()).setHardness(2.5F).setStepSound(soundTypeWood).setCreativeTab(CreativeTabs.tabDecorations).setUnlocalizedName("iron_chest"));
        registerBlock(210, "meteorite", (new BlockMeteorite()).setHardness(50.0F).setResistance(23.0F).setStepSound(soundTypePiston).setUnlocalizedName("meteorite"));
        registerBlock(211, "invisible", (new BlockInvisible()).setHardness(10.0F).setStepSound(soundTypeGlass).setLightLevel(1.0F).setUnlocalizedName("invisible")); 
        registerBlock(213, "lumiere", (new BlockAir()).setHardness(10.0F).setStepSound(soundTypeGlass).setLightLevel(1.0F).setUnlocalizedName("lumiere").setCreativeTab(CreativeTabs.tabBlock)); 
        
        registerBlock(220, "iron_ladder", (new BlockLadder()).setHardness(0.4F).setStepSound(soundTypeLadder).setUnlocalizedName("iron_ladder"));
        registerBlock(221, "powderBlock", (new BlockOre()).setHardness(20.0F).setResistance(5.0F).setStepSound(soundTypePiston).setUnlocalizedName("powderBlock"));
