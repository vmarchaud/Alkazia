...
public class BlockDynamicLiquid extends BlockLiquid
{
    ...
    {
        Block var4 = worldIn.getBlockState(p_176372_2_).getBlock(); // Alkazia - to stop water with iron ladder
        return !(var4 instanceof BlockDoor) && var4 != Blocks.standing_sign && var4 != Blocks.ladder  && var4 != Blocks.iron_ladder && var4 != Blocks.reeds ? (var4.blockMaterial == Material.portal ? true : var4.blockMaterial.blocksMovement()) : true;
    }
