...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    int yolo = 0;
    int lastYolo = 0;
    public String warning = "La triche est interdite sur Alkazia ! Veuillez d�sactiver votre pack invisible pour continuer � jouer !";
    public String name = "Alkazia";
    
    public serverType server;
    public boolean renderHUD = true;
    public boolean crossChat = true;
    ...
    public Minecraft(GameConfiguration p_i45547_1_)
    {
        ...
        File skin = new File(mcDataDir,"assets/skins");
        if(skin.exists()) {
	        for (File f : skin.listFiles()) {
    ...
    private void startGame() throws LWJGLException
    {
        ...
        // Alkazia - forbid xray pack
        this.mcResourceManager.registerReloadListener(new PackManager(this));
    ...
    private void func_175609_am() throws LWJGLException
    {
        ...
        Display.setTitle("Alkazia V4 - MC 1.8");
        	...
        	if(!this.isGamePaused) {
	        	sec++;
		      	if(lastTime == (System.currentTimeMillis() / 1000)) {
		      		...
		      		if(yolo == lastYolo) {
			      		new JOptionPane(); JOptionPane.showMessageDialog(new Frame(), warning, name, 1);
			      		System.exit(0);
		      		}
		      		yolo = lastYolo;
		      	}
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            else
            {
                while (this.gameSettings.keyBindAttack.isPressed())
                {
            		...
            		logger.info("Entre vos deux derniers clic, vous avez eu un d�lai de : " + (System.currentTimeMillis() - yolo42) + " ms");
            		
            		
            		if(this.leftClickDelayTimer == 0) {
                        this.clickMouse();
            			logger.info("Le clique a �t� pris en compte !");
    	                leftClickDelayTimer=2;
            		}
            		
            		yolo42 = System.currentTimeMillis();
	                logger.info("---------------");
                }
