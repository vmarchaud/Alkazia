...
public class BlockModelShapes
{
    ...
    public TextureAtlasSprite func_178122_a(IBlockState p_178122_1_)
    {
        ...
        if (var3 == null || var3 == this.modelManager.getMissingModel())
        {
            ...
            // Alkazia - Block Model shape
            if (var2 == Blocks.iron_ladder)
            {
                return this.modelManager.func_174952_b().getAtlasSprite("minecraft:blocks/iron_block");
            }
            
            if (var2 == Blocks.iron_chest)
            {
                return this.modelManager.func_174952_b().getAtlasSprite("minecraft:blocks/iron_block");
            }
