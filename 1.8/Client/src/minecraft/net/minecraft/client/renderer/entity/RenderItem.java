...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    public void func_175049_a(ItemStack p_175049_1_, EntityLivingBase p_175049_2_, ItemCameraTransforms.TransformType p_175049_3_)
    {
        ...
        if (p_175049_2_ instanceof EntityPlayer)
        {
            ...
            // Alkazia - bow
            else if (var6 == Items.bowGranite && var5.getItemInUse() != null)
            {
                int var8 = p_175049_1_.getMaxItemUseDuration() - var5.getItemInUseCount();

                if (var8 >= 18)
                {
                    var7 = new ModelResourceLocation("bowGranite_pulling_2", "inventory");
                }
                else if (var8 > 13)
                {
                    var7 = new ModelResourceLocation("bowGranite_pulling_1", "inventory");
                }
                else if (var8 > 0)
                {
                    var7 = new ModelResourceLocation("bowGranite_pulling_0", "inventory");
                }
            }
            
            else if (var6 == Items.bowBauxite && var5.getItemInUse() != null)
            {
                int var8 = p_175049_1_.getMaxItemUseDuration() - var5.getItemInUseCount();

                if (var8 >= 18)
                {
                    var7 = new ModelResourceLocation("bowBauxite_pulling_2", "inventory");
                }
                else if (var8 > 13)
                {
                    var7 = new ModelResourceLocation("bowBauxite_pulling_1", "inventory");
                }
                else if (var8 > 0)
                {
                    var7 = new ModelResourceLocation("bowBauxite_pulling_0", "inventory");
                }
            }
            
            else if (var6 == Items.bowOpale && var5.getItemInUse() != null)
            {
                int var8 = p_175049_1_.getMaxItemUseDuration() - var5.getItemInUseCount();

                if (var8 >= 18)
                {
                    var7 = new ModelResourceLocation("bowOpale_pulling_2", "inventory");
                }
                else if (var8 > 13)
                {
                    var7 = new ModelResourceLocation("bowOpale_pulling_1", "inventory");
                }
                else if (var8 > 0)
                {
                    var7 = new ModelResourceLocation("bowOpale_pulling_0", "inventory");
                }
            }
            
            else if (var6 == Items.bowMeteor && var5.getItemInUse() != null)
            {
                int var8 = p_175049_1_.getMaxItemUseDuration() - var5.getItemInUseCount();

                if (var8 >= 18)
                {
                    var7 = new ModelResourceLocation("bowMeteor_pulling_2", "inventory");
                }
                else if (var8 > 13)
                {
                    var7 = new ModelResourceLocation("bowMeteor_pulling_1", "inventory");
                }
                else if (var8 > 0)
                {
                    var7 = new ModelResourceLocation("bowMeteor_pulling_0", "inventory");
                }
            }
    ...
    private void registerItems()
    {
        ...
        this.registerBlock(Blocks.dragon_egg, "dragon_egg");
         ...
         // Alkazia - register all render

        this.registerBlock(Blocks.bauxite_ore, "bauxite_ore");
        this.registerBlock(Blocks.granite_ore, "granite_ore");
        this.registerBlock(Blocks.opale_ore, "opale_ore");
        this.registerBlock(Blocks.meteor_ore, "meteor_ore");
       
        this.registerBlock(Blocks.bauxite_block, "bauxite_block");
        this.registerBlock(Blocks.granite_block, "granite_block");
        this.registerBlock(Blocks.opale_block, "opale_block");
        this.registerBlock(Blocks.meteor_block, "meteor_block");
       
        this.registerBlock(Blocks.pousse, "pousse");
        this.registerBlock(Blocks.iron_chest, "iron_chest");
        this.registerBlock(Blocks.meteorite, "meteorite");
        this.registerBlock(Blocks.invisible, "invisible");
        this.registerBlock(Blocks.lumiere, "lumiere");
        this.registerBlock(Blocks.iron_ladder, "iron_ladder");
        this.registerBlock(Blocks.powderBlock, "powderBlock");
        ...
        this.registerItem(Items.bauxite_helmet, "bauxite_helmet");
	     ...
	     this.registerItem(Items.granite_helmet,"granite_helmet");
	     this.registerItem(Items.granite_chestplate, "granite_chestplate");
	     this.registerItem(Items.granite_leggings, "granite_leggings");
	     this.registerItem(Items.granite_boots, "granite_boots");
	     this.registerItem(Items.opale_helmet,"opale_helmet");
	     this.registerItem(Items.opale_chestplate, "opale_chestplate");
	     this.registerItem(Items.opale_leggings, "opale_leggings");
	     this.registerItem(Items.opale_boots, "opale_boots");
	     this.registerItem(Items.meteor_helmet,"meteor_helmet");
	     this.registerItem(Items.meteor_chestplate,"meteor_chestplate");
	     this.registerItem(Items.meteor_leggings, "meteor_leggings");
	     this.registerItem(Items.meteor_boots, "meteor_boots");
	     this.registerItem(Items.ninja_helmet, "ninja_helmet");
	     this.registerItem(Items.ninja_chestplate, "ninja_chestplate");
	     this.registerItem(Items.ninja_leggings, "ninja_leggings");
	     this.registerItem(Items.ninja_boots, "ninja_boots");
	     ...
	     this.registerItem(Items.granite_sword, "granite_sword");
	     this.registerItem(Items.granite_shovel, "granite_shovel");
	     this.registerItem(Items.granite_pickaxe, "granite_pickaxe");
	     this.registerItem(Items.granite_axe, "granite_axe");
	     this.registerItem(Items.granite_hoe,"granite_hoe");
	     this.registerItem(Items.opale_sword, "opale_sword");
	     this.registerItem(Items.opale_shovel, "opale_shovel");
	     this.registerItem(Items.opale_pickaxe, "opale_pickaxe");
	     this.registerItem(Items.opale_axe, "opale_axe");
	     this.registerItem(Items.opale_hoe, "opale_hoe");
	     this.registerItem(Items.meteor_sword, "meteor_sword");
	     this.registerItem(Items.meteor_shovel, "meteor_shovel");
	     this.registerItem(Items.meteor_pickaxe,"meteor_pickaxe");
	     this.registerItem(Items.meteor_axe ,"meteor_axe");
	     this.registerItem(Items.meteor_hoe, "meteor_hoe");
	    
	        this.registerItem(Items.bowBauxite, 0, "bowBauxite");
	        this.registerItem(Items.bowBauxite, 1, "bowBauxite_pulling_0");
	        this.registerItem(Items.bowBauxite, 2, "bowBauxite_pulling_1");
	        this.registerItem(Items.bowBauxite, 3, "bowBauxite_pulling_2");
	        this.registerItem(Items.bowGranite, 0, "bowGranite");
	        this.registerItem(Items.bowGranite, 1, "bowGranite_pulling_0");
	        this.registerItem(Items.bowGranite, 2, "bowGranite_pulling_1");
	        this.registerItem(Items.bowGranite, 3, "bowGranite_pulling_2");
	        this.registerItem(Items.bowOpale, 0, "bowOpale");
	        this.registerItem(Items.bowOpale, 1, "bowOpale_pulling_0");
	        this.registerItem(Items.bowOpale, 2, "bowOpale_pulling_1");
	        this.registerItem(Items.bowOpale, 3, "bowOpale_pulling_2");
	        this.registerItem(Items.bowMeteor, 0, "bowMeteor");
	        this.registerItem(Items.bowMeteor, 1, "bowMeteor_pulling_0");
	        this.registerItem(Items.bowMeteor, 2, "bowMeteor_pulling_1");
	        this.registerItem(Items.bowMeteor, 3, "bowMeteor_pulling_2");
	    
	     this.registerItem(Items.bauxite_ingot, "bauxite_ingot");
	     this.registerItem(Items.graniteItem, "graniteItem");
	     this.registerItem(Items.opale, "opale");
	     this.registerItem(Items.meteor_ingot, "meteor_ingot");
	     this.registerItem(Items.potionMilk, "milkPotion");
	     this.registerItem(Items.ninjaPowder, "ninjaPowder");

	     this.registerItem(Items.potionFall, "potionFall");
	     this.registerItem(Items.potionHaste, "potionHaste");
	     this.registerItem(Items.potionHaste2, "potionHaste2");
	     this.registerItem(Items.potionResistance, "potionResistance");
	     this.registerItem(Items.potionResistance2, "potionResistance2");
