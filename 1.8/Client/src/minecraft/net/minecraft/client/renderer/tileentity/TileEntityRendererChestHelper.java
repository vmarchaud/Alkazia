...
public class TileEntityRendererChestHelper
{
    ...
    // Alkazia - iron chest
    private TileEntityIronChest ironchest = new TileEntityIronChest();
    ...
    public void renderByItem(ItemStack p_179022_1_)
    {
        ...
        else
        {
            ...
            // Alkazia - cchest
            else if(var4 == Blocks.iron_chest) {
            	TileEntityRendererDispatcher.instance.renderTileEntityAt(this.ironchest, 0.0D, 0.0D, 0.0D, 0.0F);
            }
            else
            {
