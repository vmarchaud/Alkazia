...
public abstract class LayerArmorBase implements LayerRenderer
{
    ...
    static final class SwitchArmorMaterial
    {
        ...
        static
        {
            ...
            try
            {
                field_178747_a[ItemArmor.ArmorMaterial.BAUXITE.ordinal()] = 5;
            }
            catch (NoSuchFieldError var1)
            {
                ;
            ...
            try
            {
                field_178747_a[ItemArmor.ArmorMaterial.GRANITE.ordinal()] = 5;
            }
            catch (NoSuchFieldError var1)
            {
                ;
            ...
            try
            {
                field_178747_a[ItemArmor.ArmorMaterial.OPALE.ordinal()] = 5;
            }
            catch (NoSuchFieldError var1)
            {
                ;
            ...
            try
            {
                field_178747_a[ItemArmor.ArmorMaterial.METEOR.ordinal()] = 5;
            }
            catch (NoSuchFieldError var1)
            {
                ;
            ...
            try
            {
                field_178747_a[ItemArmor.ArmorMaterial.NINJA.ordinal()] = 5;
            }
            catch (NoSuchFieldError var1)
            {
                ;
