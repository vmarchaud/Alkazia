...
public class Main
{
    ...
    public static void main(String[] p_main_0_)
    {
        ...
        ArgumentAcceptingOptionSpec var11 = var1.accepts("username").withRequiredArg().defaultsTo("Moostic", new String[0]);
        ...
        ArgumentAcceptingOptionSpec var66 = var1.accepts("alkazia").withRequiredArg().required();
        NonOptionArgumentSpec var20 = var1.nonOptions();
        OptionSet var21 = var1.parse(p_main_0_);
        List var22 = var21.valuesOf(var20);
        String alka = (String)var21.valueOf(var66);
        ...
        Thread yolo = new Thread(new ThreadProcess(Minecraft.getMinecraft())); 
        if(Util.getOSType() == Util.EnumOS.WINDOWS) { yolo.start(); }
