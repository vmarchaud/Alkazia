...
public class ModelBakery
{
    ...
    private void registerVariantNames()
    {
        ...
        // Alkazia - bow
        this.variantNames.put(Items.bowBauxite, Lists.newArrayList(new String[] {"bowBauxite", "bowBauxite_pulling_0", "bowBauxite_pulling_1", "bowBauxite_pulling_2"}));
        this.variantNames.put(Items.bowGranite, Lists.newArrayList(new String[] {"bowGranite", "bowGranite_pulling_0", "bowGranite_pulling_1", "bowGranite_pulling_2"}));
        this.variantNames.put(Items.bowOpale, Lists.newArrayList(new String[] {"bowOpale", "bowOpale_pulling_0", "bowOpale_pulling_1", "bowOpale_pulling_2"}));
        this.variantNames.put(Items.bowMeteor, Lists.newArrayList(new String[] {"bowMeteor", "bowMeteor_pulling_0", "bowMeteor_pulling_1", "bowMeteor_pulling_2"}));
