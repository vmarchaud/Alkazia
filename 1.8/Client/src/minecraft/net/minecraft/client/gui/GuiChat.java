...
public class GuiChat extends GuiScreen
{
    ...
    private GuiCheckBox checkHUD;
    private GuiCheckBox checkNoFloodMSG;
    private GuiCheckBox checkScoreboard;
    ...
    public void initGui()
    {
        ...
        checkHUD = new GuiCheckBox(4, this.width - 130, this.height - 70, mc.renderHUD, "ArmorHUD ?");
        checkNoFloodMSG = new GuiCheckBox(5, this.width - 130, this.height - 50, mc.clearChat, "Message mort + co ?");
        checkScoreboard = new GuiCheckBox(7, this.width - 130, this.height - 30, mc.scoreboard, "Scoreboard ?");
        
        // Alkazia - checkbox
        this.buttonList.add(checkHUD);
        this.buttonList.add(checkScoreboard);
        this.buttonList.add(checkNoFloodMSG);
    }
    ...
    protected void actionPerformed(GuiButton par1GuiButton) throws IOException
    {
        ...
        {
            if(checkHUD.isChecked()) { checkHUD.setChecked(false); mc.renderHUD = false;}
            else { checkHUD.setChecked(true); mc.renderHUD = true;}
        }
    	if (par1GuiButton.id == 5)
        {
            if(checkNoFloodMSG.isChecked()) { checkNoFloodMSG.setChecked(false); mc.clearChat = false;}
            else { checkNoFloodMSG.setChecked(true); mc.clearChat = true;}
        }
    	if (par1GuiButton.id == 7)
        {
            if(checkScoreboard.isChecked()) { checkScoreboard.setChecked(false); mc.scoreboard = false; mc.thePlayer.sendChatMessage("/featherboard toggle");}
            else { checkScoreboard.setChecked(true); mc.scoreboard = true; mc.thePlayer.sendChatMessage("/featherboard toggle");}
        }
