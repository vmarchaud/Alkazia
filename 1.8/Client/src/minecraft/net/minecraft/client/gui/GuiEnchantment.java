        ...
        for (int var6 = 0; var6 < 3; ++var6)
        {
            ...
            if (this.isPointInRegion(60, 14 + 19 * var6, 108, 17, mouseX, mouseY) && var7 > 0 && var8 >= 0)
            {
                ...
                if (var8 >= 0 && Enchantment.func_180306_c(var8 & 255) != null)
                {
                    ...
                    // Alkazia - cancel render of enchantment will be in gui
                    String var17 = EnumChatFormatting.OBFUSCATED.toString() + mc.getSystemTime();
                    var10.add(EnumChatFormatting.WHITE.toString() + EnumChatFormatting.ITALIC.toString() + I18n.format("container.enchant.clue", new Object[] {var17}));
                }
