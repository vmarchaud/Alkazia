...
public class GuiOverlayDebug extends Gui
{
    ...
    protected List call()
    {
        ...
        else
        {
            ...
            ArrayList var5 = Lists.newArrayList(new String[] {EnumChatFormatting.GREEN + "Minecraft 1.8 (Alkazia V4)", 
            		...
            		"", 
            		EnumChatFormatting.GREEN + String.format("XYZ: %.3f / %.5f / %.3f",
            				...
            				String.format("Block: %d %d %d", 
            						new Object[]{Integer.valueOf(var1.getX()), 
            						Integer.valueOf(var1.getY()), Integer.valueOf(var1.getZ())}), 
            						String.format("Chunk: %d %d %d in %d %d %d", new Object[]{Integer.valueOf(var1.getX() & 15),
            								Integer.valueOf(var1.getY() & 15),
            								Integer.valueOf(var1.getZ() & 15),
            								Integer.valueOf(var1.getX() >> 4),
            								Integer.valueOf(var1.getY() >> 4),
            								Integer.valueOf(var1.getZ() >> 4)}),
            ...
            if (this.mc.theWorld != null && this.mc.theWorld.isBlockLoaded(var1))
            {
                ...
                var5.add(EnumChatFormatting.GREEN + "Biome: " + var6.getBiome(var1, this.mc.theWorld.getWorldChunkManager()).biomeName);
            ...
            if (this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK && this.mc.objectMouseOver.func_178782_a() != null)
            {
                ...
                var5.add(String.format(EnumChatFormatting.GREEN + "Position regardé : %d %d %d", new Object[] {Integer.valueOf(var9.getX()), Integer.valueOf(var9.getY()), Integer.valueOf(var9.getZ())}));
            }
    ...
    protected List func_175238_c()
    {
        ...
        long var7 = var3 - var5;
        ArrayList var9 = Lists.newArrayList(new String[] {String.format("Java: %s %dbit", new Object[]{System.getProperty("java.version"), Integer.valueOf(this.mc.isJava64bit() ? 64 : 32)}),
        		EnumChatFormatting.GREEN + String.format("Mem: % 2d%% %03d/%03dMB", new Object[]{Long.valueOf(var7 * 100L / var1), Long.valueOf(func_175240_a(var7)), Long.valueOf(func_175240_a(var1))}), 
        		EnumChatFormatting.GREEN + String.format("Mem allouée: % 2d%% %03dMB", new Object[]{Long.valueOf(var3 * 100L / var1), Long.valueOf(func_175240_a(var3))}), "", String.format("Resolution: %dx%d (%s)", new Object[]{Integer.valueOf(Display.getWidth()), Integer.valueOf(Display.getHeight()), GL11.glGetString(GL11.GL_VENDOR)}), GL11.glGetString(GL11.GL_RENDERER), GL11.glGetString(GL11.GL_VERSION)});
