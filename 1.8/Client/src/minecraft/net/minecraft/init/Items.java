...
public class Items
{
    ...
    public static final ItemArmor granite_helmet;
    public static final ItemArmor granite_chestplate;
    public static final ItemArmor granite_leggings;
    public static final ItemArmor granite_boots;
    public static final ItemArmor opale_helmet;
    public static final ItemArmor opale_chestplate;
    public static final ItemArmor opale_leggings;
    public static final ItemArmor opale_boots;
    public static final ItemArmor meteor_helmet;
    public static final ItemArmor meteor_chestplate;
    public static final ItemArmor meteor_leggings;
    public static final ItemArmor meteor_boots;
    public static final ItemArmor ninja_helmet;
    public static final ItemArmor ninja_chestplate;
    public static final ItemArmor ninja_leggings;
    public static final ItemArmor ninja_boots;
    ...
    public static final Item granite_sword;
    public static final Item granite_shovel;
    public static final Item granite_pickaxe;
    public static final Item granite_axe;
    public static final Item granite_hoe;
    public static final Item opale_sword;
    public static final Item opale_shovel;
    public static final Item opale_pickaxe;
    public static final Item opale_axe;
    public static final Item opale_hoe;
    public static final Item meteor_sword;
    public static final Item meteor_shovel;
    public static final Item meteor_pickaxe;
    public static final Item meteor_axe;
    public static final Item meteor_hoe;
    
    public static final ItemBowBauxite bowBauxite;
    public static final ItemBowGranite bowGranite;
    public static final ItemBowOpale bowOpale;
    public static final ItemBowMeteor bowMeteor;
    
    public static final Item bauxite_ingot;
    public static final Item graniteItem;
    public static final Item opale;
    public static final Item meteor_ingot;
    public static final Item potionMilk;
    public static final Item ninjaPowder;
    public static final Item potionFall;
    public static final Item potionResistance;
    public static final Item potionResistance2;
    public static final Item potionHaste;
    public static final Item potionHaste2;
    ...
    static
    {
        ...
        else
        {
         ...
         // Alkazia - register new item
    	 	bauxite_helmet = (ItemArmor)getRegisteredItem("bauxite_helmet");
    	    bauxite_chestplate = (ItemArmor)getRegisteredItem("bauxite_chestplate");
    	    bauxite_leggings = (ItemArmor)getRegisteredItem("bauxite_leggings");
    	    bauxite_boots = (ItemArmor)getRegisteredItem("bauxite_boots");
    	    granite_helmet = (ItemArmor)getRegisteredItem("granite_helmet");
    	    granite_chestplate = (ItemArmor)getRegisteredItem("granite_chestplate");
    	    granite_leggings = (ItemArmor)getRegisteredItem("granite_leggings");
    	    granite_boots = (ItemArmor)getRegisteredItem("granite_boots");
    	    opale_helmet = (ItemArmor)getRegisteredItem("opale_helmet");
    	    opale_chestplate = (ItemArmor)getRegisteredItem("opale_chestplate");
    	    opale_leggings = (ItemArmor)getRegisteredItem("opale_leggings");
    	    opale_boots = (ItemArmor)getRegisteredItem("opale_boots");
    	    meteor_helmet = (ItemArmor)getRegisteredItem("meteor_helmet");
    	    meteor_chestplate = (ItemArmor)getRegisteredItem("meteor_chestplate");
    	    meteor_leggings = (ItemArmor)getRegisteredItem("meteor_leggings");
    	    meteor_boots = (ItemArmor)getRegisteredItem("meteor_boots");
    	    ninja_helmet = (ItemArmor)getRegisteredItem("ninja_helmet");
    	    ninja_chestplate = (ItemArmor)getRegisteredItem("ninja_chestplate");
    	    ninja_leggings = (ItemArmor)getRegisteredItem("ninja_leggings");
    	    ninja_boots = (ItemArmor)getRegisteredItem("ninja_boots");
    	    
    	     bauxite_sword = getRegisteredItem("bauxite_sword");
    	     bauxite_shovel = getRegisteredItem("bauxite_shovel");
    	     bauxite_pickaxe = getRegisteredItem("bauxite_pickaxe");
    	     bauxite_axe = getRegisteredItem("bauxite_axe");
    	     bauxite_hoe = getRegisteredItem("bauxite_hoe");
    	     granite_sword = getRegisteredItem("granite_sword");
    	     granite_shovel = getRegisteredItem("granite_shovel");
    	     granite_pickaxe = getRegisteredItem("granite_pickaxe");
    	     granite_axe = getRegisteredItem("granite_axe");
    	     granite_hoe = getRegisteredItem("granite_hoe");
    	     opale_sword = getRegisteredItem("opale_sword");
    	     opale_shovel = getRegisteredItem("opale_shovel");
    	     opale_pickaxe = getRegisteredItem("opale_pickaxe");
    	     opale_axe = getRegisteredItem("opale_axe");
    	     opale_hoe = getRegisteredItem("opale_hoe");
    	     meteor_sword = getRegisteredItem("meteor_sword");
    	     meteor_shovel = getRegisteredItem("meteor_shovel");
    	     meteor_pickaxe = getRegisteredItem("meteor_pickaxe");
    	     meteor_axe = getRegisteredItem("meteor_axe");
    	     meteor_hoe = getRegisteredItem("meteor_hoe");
    	    
    	     bowBauxite = (ItemBowBauxite)getRegisteredItem("bowBauxite");
    	     bowGranite = (ItemBowGranite)getRegisteredItem("bowGranite");
    	     bowOpale = (ItemBowOpale)getRegisteredItem("bowOpale");
    	     bowMeteor = (ItemBowMeteor)getRegisteredItem("bowMeteor");
    	    
    	     bauxite_ingot = getRegisteredItem("bauxite_ingot");
    	     graniteItem = getRegisteredItem("graniteItem");
    	     opale = getRegisteredItem("opale");
    	     meteor_ingot = getRegisteredItem("meteor_ingot");
    	     potionMilk = getRegisteredItem("milkPotion");
    	     ninjaPowder = getRegisteredItem("ninjaPowder");
    	     potionFall = getRegisteredItem("potionFall");
    	     potionHaste = getRegisteredItem("potionHaste");
    	     potionHaste2 = getRegisteredItem("potionHaste2");
    	     potionResistance = getRegisteredItem("potionResistance");
    	     potionResistance2 = getRegisteredItem("potionResistance2");
