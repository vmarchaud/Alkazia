...
public class Blocks
{
    ...
    public static final Block granite_ore;
    public static final Block opale_ore;
    public static final Block meteor_ore;
    
    public static final Block bauxite_block;
    public static final Block granite_block;
    public static final Block opale_block;
    public static final Block meteor_block;
    
    public static final Block pousse;
    public static final BlockIronChest iron_chest;
    public static final Block meteorite;
    public static final Block invisible;
    public static final Block lumiere;
    public static final Block iron_ladder;
    public static final Block powderBlock;
    ...
    static
    {
        ...
        else
        {
            ...
            granite_ore = getRegisteredBlock("granite_ore");
            opale_ore = getRegisteredBlock("opale_ore");
            meteor_ore = getRegisteredBlock("meteor_ore");
           
            bauxite_block = getRegisteredBlock("bauxite_block");
            granite_block = getRegisteredBlock("granite_block");
            opale_block = getRegisteredBlock("opale_block");
            meteor_block = getRegisteredBlock("meteor_block");
           
            pousse = getRegisteredBlock("pousse");
            iron_chest = (BlockIronChest)getRegisteredBlock("iron_chest");
            meteorite = getRegisteredBlock("meteorite");
            invisible = getRegisteredBlock("invisible");
            lumiere = getRegisteredBlock("lumiere");
            iron_ladder = getRegisteredBlock("iron_ladder");
            powderBlock = getRegisteredBlock("powderBlock");
