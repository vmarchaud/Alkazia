...
public abstract class EntityLivingBase extends Entity
{
    ...
    public void fall(float distance, float damageMultiplier)
    {
        ...
        PotionEffect var42 = this.getActivePotionEffect(Potion.fall);
        float var4 = var3 != null ? (float)(var3.getAmplifier() + 0) : 0.0F;
        // Alkazia - potion fall effect
    ...
    public void moveEntityWithHeading(float p_70612_1_, float p_70612_2_)
    {
        ...
        if (this.isServerWorld())
        {
            ...
            else
            {
                ...
                if (this.isOnIronLadder()) // Alkazia - Iron Ladder
                {
                    var6 = 0.15F;
                    this.motionX = MathHelper.clamp_double(this.motionX, (double)(-var6), (double)var6);
                    this.motionZ = MathHelper.clamp_double(this.motionZ, (double)(-var6), (double)var6);
                ...
                if (this.isCollidedHorizontally && this.isOnIronLadder()) // Alkazia - iron ladder
                {
                    this.motionY = 0.6D;
                }
...
// Alkazia - milk Potion 
    ...
    public void clearActiveNegativePotions()
    {
        ...
        while (var1.hasNext())
        {
            Integer var2 = (Integer)var1.next();
            PotionEffect var3 = (PotionEffect)this.activePotionsMap.get(var2);
            if (!this.worldObj.isRemote && (var3.getEffectName() == "potion.poison" || var3.getEffectName() == "potion.weakness" || var3.getEffectName() == "potion.moveSlowdown"))
            {
                var1.remove();
                this.onFinishedPotionEffect(var3);
            }
    ...
    public boolean isOnIronLadder()
    {
        ...
        int var3 = MathHelper.floor_double(this.posZ);
        Block var4 = this.worldObj.getBlockState(new BlockPos(var1, var2, var3)).getBlock();
        return (var4 == Blocks.iron_ladder) && (!(this instanceof EntityPlayer) || !((EntityPlayer)this).func_175149_v());
    }
    ...
    public boolean hasFallEffect() {
        ...
        while (var1.hasNext())
        {
            Integer var2 = (Integer)var1.next();
            PotionEffect var3 = (PotionEffect)this.activePotionsMap.get(var2);
            if (this.worldObj.isRemote && var3.getEffectName() == "potion.fall")
            {
            	return true;
            }
        }
