    ...
    public boolean interact(EntityPlayer p_70085_1_)
    {
     ...
     // Alkazia - add craft of milk potion
        else if (var2 != null && var2.getItem() == Items.glass_bottle && !p_70085_1_.capabilities.isCreativeMode)
        {
        	if (var2.stackSize-- == 1)
            {
        		p_70085_1_.inventory.setInventorySlotContents(p_70085_1_.inventory.currentItem, new ItemStack(Items.potionMilk));
            }
            else if (!p_70085_1_.inventory.addItemStackToInventory(new ItemStack(Items.potionMilk)))
            {
            	p_70085_1_.dropPlayerItemWithRandomChoice(new ItemStack(Items.potionMilk, 1, 0), false);
            }
            return true;
        }
        else
