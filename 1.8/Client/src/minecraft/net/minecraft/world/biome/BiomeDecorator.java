...
public class BiomeDecorator
{
    ...
    public void func_180292_a(World worldIn, Random p_180292_2_, BiomeGenBase p_180292_3_, BlockPos p_180292_4_)
    {
        ...
        else
        {
            ...
            this.bauxiteGen = new WorldGenMinable(Blocks.bauxite_ore.getDefaultState(), 9);
            this.graniteGen = new WorldGenMinable(Blocks.granite_ore.getDefaultState(), 7);
            this.opaleGen = new WorldGenMinable(Blocks.opale_ore.getDefaultState(), 5);
    ...
    protected void generateOres()
    {
        ...
        this.genStandardOre1(25, this.ironGen, this.field_180293_d.field_177832_ai, this.field_180293_d.field_177834_aj);
        ...
        this.genStandardOre1(5, this.field_180298_q, this.field_180293_d.field_177826_au, this.field_180293_d.field_177824_av);
        ...
        // Alkazia - Gen at Y 
        this.genStandardOre1(18, this.bauxiteGen, 25, 64);
        this.genStandardOre1(5, this.graniteGen, 10, 32);
        this.genStandardOre1(3, this.opaleGen, 0, 16);
    }
}
