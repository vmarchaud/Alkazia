...
public class SpigotWorldConfig
{
    ...
    {
        chunksPerTick = getInt( "chunks-per-tick", 100);
    ...
    public int animalActivationRange = 2;
    public int monsterActivationRange = 8;
    ...
    {
        arrowDespawnRate = getInt( "arrow-despawn-rate", 600  );
    ...
    {
        walkExhaustion = (float) getDouble( "hunger.walk-exhaustion", 0.1 );
        sprintExhaustion = (float) getDouble( "hunger.sprint-exhaustion", 0.4 );
        combatExhaustion = (float) getDouble( "hunger.combat-exhaustion", 0.2 );
