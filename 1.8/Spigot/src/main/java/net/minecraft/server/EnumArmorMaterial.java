...
public enum EnumArmorMaterial {
	/** Alkazia */
    LEATHER("LEATHER", 0, 5, new int[] { 1, 3, 2, 1}, 15), 
    ...
    private int[] g;
    private int h;
    private static final EnumArmorMaterial[] i = new EnumArmorMaterial[] { LEATHER, CHAIN, IRON, GOLD, DIAMOND, BAUXITE, GRANITE, OPALE, METEOR, NINJA}; /** Alkazia */
    ...
    public int a(int i) {
        return ItemArmor.k[i] * this.f + 150;
    }
