...
public enum EnchantmentSlotType {
    ...
    public boolean canEnchant(Item item) {
        if (this == ALL) {
            ...
            return item instanceof ItemSword ? this == WEAPON : 
            	(item instanceof ItemTool ? this == DIGGER : 
            		(item instanceof ItemBow ? this == BOW : 
                		(item instanceof ItemBowBauxite ? this == BOW : 
                    		(item instanceof ItemBowOpale ? this == BOW : 
                        		(item instanceof ItemBowGranite ? this == BOW : 
                            		(item instanceof ItemBowMeteor ? this == BOW : 
            			(item instanceof ItemFishingRod ? this == FISHING_ROD : false)))))));
        }
    }
}