...
public enum EnumToolMaterial {
    ...
    EMERALD("EMERALD", 3, 3, 1561, 7.0F, 3.0F, 10),
    ...
    private final int j;
    private static final EnumToolMaterial[] k = new EnumToolMaterial[] { WOOD, STONE, IRON, EMERALD, GOLD, BAUXITE, GRANITE, OPALE, METEOR}; 
