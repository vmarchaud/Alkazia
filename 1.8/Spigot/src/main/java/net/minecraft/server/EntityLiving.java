...
public abstract class EntityLiving extends Entity {
    ...
    public void e(float f, float f1) {
        ...
        MobEffect var42 = this.getEffect(MobEffectList.FALL);
    ...
    public void clearNegativeEffect() {
        ...
        while (iterator.hasNext()) {
            Integer integer = (Integer) iterator.next();
            MobEffect mobeffect = (MobEffect) this.effects.get(integer);
            if (!this.world.isStatic && (mobeffect.g() == "potion.poison" || mobeffect.g() == "potion.weakness" || mobeffect.g() == "potion.moveSlowdown" )) {
                iterator.remove();
                this.b(mobeffect);
            }
        }
    ...
    public boolean isOnIronLadder() {
        ...
        return block == Blocks.IRON_LADDER && (!(this instanceof EntityHuman) || !((EntityHuman) this).v());
    }
}
