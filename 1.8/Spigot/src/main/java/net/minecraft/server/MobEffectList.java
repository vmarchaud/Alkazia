...
public class MobEffectList {
    ...
    public static final MobEffectList FALL = (new MobEffectList(24, new MinecraftKey("fall_resistance"), false, 3426654)).c("potion.fall").b(3, 2);
    ...
    public void tick(EntityLiving entityliving, int i) {
        if (this.id == MobEffectList.REGENERATION.id) {
            ...
            if (this.id == MobEffectList.HARM.id && !entityliving.bl() || this.id == MobEffectList.HEAL.id && entityliving.bl()) {
                entityliving.damageEntity(DamageSource.MAGIC, (float) (3 << i));
            }
        } else {
