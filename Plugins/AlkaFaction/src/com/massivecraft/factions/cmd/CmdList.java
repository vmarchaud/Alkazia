...
public class CmdList extends FCommand {
    ...
    public void perform() {
        ...
        for (final Faction faction : factionList.subList(start, end)) {
            ...
            lines.add(this.p.txt.parse("%s<i> %d/%d online, %d/%d/%d", faction.getTag(this.fme), faction.getFPlayersWhereOnline(true).size(), faction.getFPlayers().size(), faction.getLandRounded(), faction.getPowerRounded(), faction.getPowerMaxRounded()));
        }
